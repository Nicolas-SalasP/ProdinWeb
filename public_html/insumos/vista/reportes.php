...
<br>
<?php if ($perfil_session == 3 or $perfil_session == 4) {?><h5><a href="exportar_solicitudes.php"><p align="center">Exportar a excel</p></a></h5><?}?>

<div class="col-sm-10">
<div>

<form id="buscador" name="buscador" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>" >
  <input id="buscar" name="buscar" type="search" placeholder="Filtrar…" autofocus >
...
<?php if ($perfil_session == 2 or $perfil_session == 5) {?> <th scope="col">Precio</th>  <?php } ?>    
      <th scope="col">Estado</th>      
<?php if ($perfil_session == 2 or $perfil_session == 3 or $perfil_session == 5) {?>
      <th scope="col"></th>
...
FROM tmp as tmp 
left outer join productos as prd on tmp.id_producto = prd.id_producto
left outer join areas as area on tmp.area = area.id_area ";
}
...
echo" <td>$nombre</td>";
echo" <td>$cantidad</td>";
if ($perfil_session == 2 or $perfil_session == 5) { echo "<td>$precio</td>";}
echo" <td>$estado</td>";
echo "<td><input type='hidden' name='id' value='$id'></td>";

//if (($perfil_session == 2 or $perfil_session == 4) and $estado != 'Entregado' and $estado != 'Aprobado') {
if (($perfil_session == 2 or $perfil_session == 5) and $estado == '') {
...
if (($perfil_session == 3 or $perfil_session == 4) and $estado == 'Aprobado') {
