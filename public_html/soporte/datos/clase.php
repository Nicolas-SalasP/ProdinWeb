...
class Conexion  // se declara una clase para hacer la conexion con la base de datos
{
	...
	function Conexion()
	{
		...
		$conection['pass']="123456";             //password
		$conection['base']="mantencion";           //base de datos
    ...
    public static function getClientes() 
		{
			...
			$obj_cliente->executeQuery("SELECT
rp.idregPersonal, 
rp.nombrePersonal,
rp.correoPersonal,
rp.dominioPersonal,
...
dp.detUser
FROM regpersonal rp
LEFT JOIN detpersonal dp ON rp.idregPersonal=dp.iddetPersonal ORDER BY idregPersonal ASC"); // ejecuta la consulta para traer al cliente
	...
	function Cliente($nro=0) // declara el constructor, si trae el numero de cliente lo busca , si no, trae todos los clientes
	{
		...
		{
			$obj_cliente=new sQuery();
			$result=$obj_cliente->executeQuery("SELECT
rp.idregPersonal, 
rp.nombrePersonal,
rp.correoPersonal,
rp.dominioPersonal,
...
dp.detUser
FROM regpersonal rp
LEFT JOIN detpersonal dp ON rp.idregPersonal=dp.iddetPersonal ORDER BY idregPersonal ASC where id = $nro"); // ejecuta la consulta para traer al cliente 
