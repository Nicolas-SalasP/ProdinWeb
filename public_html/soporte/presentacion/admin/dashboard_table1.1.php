...
var mostrarValor = function(x){
        document.getElementById('seleccion').value=x;
        }
     ...
     <div class="header clearfix">
        <nav>
          <ul class="nav nav-pills pull-left">
            ...
            <li role="presentation" class="active"><a href="#">Entradas</a></li>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <select id="selectbasic" name="entradas" class="form-control" onchange="mostrarValor(this.value);">
       <option>Seleccione una Opción...</option>
        <?php        
        include("../../datos/conn.php");
        $insumo=mysql_query("select * from Inventarioinsumos",$conexion);
        while($row = mysql_fetch_array($insumo))
        {
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="txtimpresora" name="txtimpresora" type="text" placeholder="" class="form-control input-md">
  </div>
</div>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Cantidad Entrada</label>  
  <div class="col-md-2">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Proveedor</label>  
  <div class="col-md-4">
  <input id="textinput" name="textinput" type="text" placeholder="" class="form-control input-md">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Fecha Recepción</label>  
  <div class="col-md-4">
  <input id="textinput" name="textinput" type="text" placeholder="" class="form-control input-md" required="">
