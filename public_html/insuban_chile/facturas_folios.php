<?
$sql="SELECT * FROM etiquetados_folios AS etiq, producto AS pro, estado_folio AS esf, operarios AS ope, origenes AS o, procedencia AS proce where etiq.id_operarios = ope.id_operarios and etiq.id_etiquetados_folios = etiq.id_etiquetados_folios and etiq.id_estado_folio = esf.id_estado_folio and etiq.id_producto != 0 and etiq.id_producto = pro.id_producto and etiq.id_procedencia = proce.id_procedencia and etiq.id_origen = o.id_origen  and etiq.factura_importada = $factura_importada order by etiq.id_etiquetados_folios, etiq.id_producto desc";
    ...
    <td height="38" valign="top">
      ...
      <table width="762" border="1" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td width="61" height="14" nowrap="nowrap" bgcolor="#CCCCCC" class="titulo">&nbsp;Producto</td>
          ...
          <td width="85" nowrap="nowrap" bgcolor="#CCCCCC" class="titulo">&nbsp;Valor Indice</td>
          <td width="87" nowrap="nowrap" bgcolor="#CCCCCC" class="titulo">&nbsp;Valor Unitario</td>
          <td width="73" nowrap="nowrap" bgcolor="#CCCCCC" class="titulo">&nbsp;Procedencia</td>
          <td width="44" nowrap="nowrap" bgcolor="#CCCCCC" class="titulo">&nbsp;&nbsp;Origen</td>
          <td width="79" nowrap="nowrap" bgcolor="#CCCCCC" class="titulo">&nbsp;&nbsp;Responsable</td>
