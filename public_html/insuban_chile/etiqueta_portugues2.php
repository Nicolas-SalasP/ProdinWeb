...
<!--    <? echo $contenido_alt; ?><?if ($id_destinos != 311) {?>
    ...
    <? echo $contenido_alt; ?><?if ($id_destinos != 311) {?>
    Unidades de Envolt&oacute;rio Natural Salgado de Su&iacute;no<?}?>
...
<? if ($id_destinos != 311) {?>
  ...
  <tr>
    <td height="20">&nbsp;</td>
    <td>&nbsp;</td>
    <td height="20" colspan="2"><? echo $domicilio?>&nbsp;<?echo $ciudad?>&nbsp;<?echo $pais?></td>
  </tr>
...
<? if ($id_destinos != 311) {?>
  ...
  <tr>
    ...
    <? if($id_destinos != 130 or $id_destinos != 14 or $id_destinos != 5 or $id_destinos != 132 or $id_destinos != 158 or $id_destinos != 243 or $id_destinos != 282)
	{
...
if ($id_destinos == 253) {
  ...
  <tr>
    ...
    <td height="20"><? $dat3=split(" ",$f_termino);
     ...
     if ($id_destinos == 253 or $id_destinos == 14 )  {
      $dat[0]=$dat[0]+2;
    }else{
      $ano=$dat[0];
    }
