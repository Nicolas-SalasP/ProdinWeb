...
$sql2="SELECT * FROM paking AS p, etiquetados_folios As ef, calibre AS c, producto AS pro, medidas_productos AS mp, etiquetas_agrosuper as eas 
where p.id_paking_relacion=$id_paking_relacion 
and ef.id_etiquetados_folios = eas.id_folio
...
<?if ($id_destinos ==324) {?> <!--condicion SAP  -->
...
<tr>
<td>&nbsp;</td>
<td height="19" class="style7">Fecha de Faena </td> 
    <td class="style7">:</td>
    <td class="style7"><? 
...
<tr>
    <td>&nbsp;</td>
    <td height="19" class="style7">Fecha de Empaque </td>
    <td class="style7">:</td>
    <td class="style7"><? 
