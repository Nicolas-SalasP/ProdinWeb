  ...
  <tr>
   ...
   <? //echo "ini $ini - fin $fin - otro $otro -  id_destinosotro $id_destinosotro - bultos $ccccc -  desde $desde - hasta $hasta - id_etiqueta_idioma $id_etiqueta_idioma - pallet $pallet"; ?>
    ...
    <? //if($id_etiquetas == 15 or $id_etiquetas == 7){
      ...
      <div align="center"> <a href="javascript:Abrir_ventana('etiqueta_espanol_pallet_2.php?ini=<? echo $ini?>&fin=<? echo $fin?>&amp;id_destinos=<? echo $id_destinosotro?>&amp;id_etiqueta_idioma=<? echo $id_etiqueta_idioma?>&amp;pallet=<?echo $pallet?>')"><img src="jpg/impresora.jpg" alt="Etiquetas" width="35" height="39" border="0" /><br />
...
<? if($id_destinosotro and $id_etiqueta_idioma == 2){?>
      ...
      <div align="center"> <a href="javascript:Abrir_ventana('etiqueta_ingles_pallet.php?ini=<? echo $ini?>&fin=<? echo $fin?>&amp;id_destinos=<? echo $id_destinosotro?>&amp;id_etiqueta_idioma=<? echo $id_etiqueta_idioma?>&amp;pallet=<?echo $pallet?>')"><img src="jpg/impresora.jpg" alt="Etiquetas" width="35" height="39" border="0" /><br />
        Imprimir Etiquetas</a></div>		
      <? }?>
