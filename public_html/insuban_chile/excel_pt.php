...
header("content-disposition: attachment;filename=Etiquetas_Folios.csv");
 ...
 echo "CODIGO;PRODUCTO;CALIBRE;U/MEDIDA;MEDIDA;C/P;C/E;BIDONES;CONTENIDO\n";
  ...
  echo "$id_cruce_tablas;$producto;$calibre;$unidad_medida;$medidas_productos;$caract_producto;$caract_envases;$total_bidones;$contenido_unidades\n";
  }
...
AND ef.id_caract_envases = carenv.id_caract_envases
AND ef.id_origen = orig.id_origen
AND e.id_estado_folio != 7 and e.id_estado_folio != 5 and e.id_estado_folio != 6 and e.id_estado_folio != 10 and e.id_estado_folio != 9 and e.id_estado_folio != 4 and ef.id_caract_producto = 25  and ef.id_procedencia = 'N' and hipt.f_toma_inventario  = '$f_toma_inventariof' group by ef.id_cruce_tablas order by p.producto asc";
$resultc=mysql_query($sqlc);
$cuantos=mysql_num_rows($resultc);
 echo "CODIGO;PRODUCTO;CALIBRE;U/MEDIDA;MEDIDA;C/P;C/E;CAJAS;CONTENIDO\n";
 while ($rowc=mysql_fetch_array($resultc))
	...
	$contenido_unidadesc=$rowc[contenido_unidadesc];
	 ...
	 echo "$id_cruce_tablasc;$productoc;$calibrec;$unidad_medidac;$medidas_productosc;$caract_productoc;$caract_envasesc;$total_bidonesc;$contenido_unidadesc\n";
	}
?>