...
//$pdf=new FPDF('P','pt',array(300,270)); 
...
$pdf->AddPage('P',array(300,280));
		  ...
		  $pdf->SetY(15.0);$pdf->SetX(10.0);$pdf->SetFont('Arial','B',15);$pdf->Cell(0,0,"C-SMALL INTESTINE");
		  $pdf->Line(10,22,283,22);//horzontal 1
		  $pdf->Line(10,24,283,24);//horizontal 2

		  $pdf->Rect(10,33,130,14);
		  $pdf->SetY(40.0);$pdf->SetX(10.0);$pdf->SetFont('Arial','',11); $pdf->Cell(0,0,"CALIBER: ");
		  $pdf->SetY(40.0);$pdf->SetX(75.0);$pdf->SetFont('Arial','b',13); $pdf->Cell(0,0,"$cal");
		  $pdf->Rect(155,33,130,14);
		  $pdf->SetY(40.0);$pdf->SetX(155.0);$pdf->SetFont('Arial','',11); $pdf->Cell(0,00,"MEASURE:");
		  $pdf->SetY(40.0); $pdf->SetX(215.0);$pdf->SetFont('Arial','b',13); $pdf->Cell(0,00,"$medidas_productos");
		  $pdf->SetY(55.0);$pdf->SetX(10.0);$pdf->SetFont('Arial','',10); $pdf->Cell(0,00,"Constains:");
		  $pdf->SetY(55.0);$pdf->SetX(65.0);$pdf->SetFont('Arial','b',10); $pdf->Cell(0,00,"$conte");
		  $pdf->SetY(55.0);$pdf->SetX(170);$pdf->SetFont('Arial','',10); $pdf->Cell(0,00,"Units");
		  $pdf->SetY(66.0);$pdf->SetX(10.0);$pdf->SetFont('Arial','',10); $pdf->Cell(0,00,"Elaboration date:");
		  $pdf->SetY(66.0);$pdf->SetX(125.0);$pdf->SetFont('Arial','b',10); $pdf->Cell(0,00,"$f_elaboracion");
		  $pdf->SetY(80.0);$pdf->SetX(10.0);$pdf->SetFont('Arial','',10); $pdf->Cell(0,00,"Preferably use before:");
		  $pdf->SetY(80.0);$pdf->SetX(185.0);$pdf->SetFont('Arial','b',10); $pdf->Cell(0,00,"$f_vencimiento");
		  $pdf->SetY(93.0);$pdf->SetX(10.0);$pdf->SetFont('Arial','',10); $pdf->Cell(0,00,"Operator:");
		  $pdf->SetY(93.0);$pdf->SetX(65.0);$pdf->SetFont('Arial','b',10); $pdf->Cell(0,00,"$nomope $apellope");
		  $pdf->SetY(106.0);$pdf->SetX(10.0);$pdf->SetFont('Arial','',10); $pdf->Cell(0,00,"Condition:");
		  ...
		  $pdf->SetY(190.0);$pdf->SetX(10.0);$pdf->SetFont('Arial','',7); $pdf->Cell(0,00,"Country of Origin: CHILE");
		  $pdf->SetY(200.0);$pdf->SetX(10.0);$pdf->SetFont('Arial','',7); $pdf->Cell(0,00,"SAG Record: 13-62    SESMA Resolution: 9242/04");
		  $pdf->SetY(208.0);$pdf->SetX(10.0);$pdf->SetFont('Arial','',7); $pdf->Cell(0,00,"Keep in a fresh and dry place in a enviromental temperature.");
