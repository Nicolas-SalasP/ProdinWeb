...
$sql="SELECT * FROM etiquetados_folios where folio_m3 ='$id_etf2' and id_estado_folio != 11";
...
if(!$op) $op=0; 
$sql="SELECT * FROM etiquetados_folios  WHERE id_etiquetados_folios=id_etiquetados_folios and id_etiquetados_folios != 0  and ano >= 2017 order by id_etiquetados_folios desc  LIMIT $op ,1";
$result=mysql_query($sql);
}
...
// etiqueta agrosuper *******************************************************************************
 ...
 $query1="SELECT * FROM etiquetas_agrosuper order by id_etiquetas_unidad Desc limit 1";
...
//echo "recepcion";
  $dat20=split(" ",$f_recepcion);
  $dat222=split("-",$dat20[0]);
  $f_recepcion="$dat222[2]-$dat222[1]-$dat222[0]";
...
//echo "modificar";
  ...
  $f_elaboracion2="$dat[0]$dat[1]$dat[2]";
  ...
  $f_termino2="$dat6[2]-$dat6[1]-$dat6[0]";
	...
	// echo "mes $mes<br>";
  	$dia="$datven[2]";
	// echo "dia $dia<br>";
	$f_vencimiento2="$fech-$mes-$dia";
	// echo " f_vencimiento2 $f_vencimiento2";
...
if($cambiar) {
	...
	if ($codigo == 534 ) { //  30/32 sudamerica
		$code_a2a = 108;
        $sku = 1022780;
        $code_a3="2051040901300"; 
	}if ($codigo == 535 or $codigo == 594) { // 32/35 
		$code_a2a = 130;
        if ($mercado == 1){$sku = 1023292;$code_a3="2021040901300";}else{$sku = 1022781;$code_a3="2051040901300";} // mercado==1 Europa
	}if ($codigo == 536 or $codigo == 595) {// 35/38 sudamerica
		$code_a2a = 131;
        $sku = 1022782;
        $code_a3="2051040901300"; 
	}if ($codigo == 537 or $codigo == 596) {// 38/40 sudamerica
		$code_a2a = 135;
        $sku = 1022783;
        $code_a3="2051040901300"; 
	}if ($codigo == 538 or $codigo == 597) {// 40/42 sudamerica
		$code_a2a = 159;
        $sku = 1022784;
        $code_a3="2051040901300"; 
	}if ($codigo == 539) {// -/35 sudamerica
		$code_a2a = 163;
        $sku = 1022785;
        $code_a3="2051040901300"; 
	}if ($codigo == 540 or $codigo == 609) {// 35/39 
		$code_a2a = 209;
        if ($mercado == 1){$sku = 1023264;$code_a3="2051040601300";}else{$sku = 1022786;$code_a3="2051040901300";} // mercado==1 Europa
	}if ($codigo == 541) {// 39/42 sudamerica
		$code_a2a = 219;
        $sku = 1022787;
        $code_a3="2051040901300"; 
    }if ($codigo == 610 or $codigo == 611) { // -/35 Europa
        $code_a2a = 163;
        ...
        $sku = 1022788;
        $code_a3="2051040901300"; 
	}if ($codigo == 642 or $codigo == 643) { // 37/40 sudamerica
        $code_a2a = '006';
        $sku = 1023295;
        $code_a3="2081012903300";
    }//if ($codigo == 643) { // 37/40 sudamerica
       // $code_a2a = '006';
        //$sku = 1023295;
    //}else{
//$code_a3="2051040901300";    
...
$code_a2="$code_a2a";
//if (($codigo == 535 or $codigo == 594) and $mercado == 1) { // 32/35 Europa // mercado==1 Europa
//$code_a3="2021040901300";
//}elseif ($codigo == 610 or $codigo == 611) { // -/35 sudamerica
//$code_a3="2081012901300";
//}elseif ($codigo == 642 or $codigo == 643 ) { // -/35 sudamerica
//$code_a3="2081012903300";
//}elseif ($codigo == 540 or $codigo == 609 ) { // 35/39 Europa
//}elseif ($codigo == 609 ) { // 35/39 Europa    //modificacion tubing 24102022
//$code_a3="2051040601300";
//}else{
//$code_a3="2051040901300";    
//}
...
$bar_code=$code_a1.$code_a2.$code_a3.$code_a4.$code_a5.$code_a6_;

$hoy2 = date(Ymd);
$hasta = $corr + $cant;

$sql_mod_eti="INSERT INTO etiquetas_agrosuper (id_cruce_tabla, cantidad, desde, hasta, fecha_emision, fhoy, id_folio, bar_code,sku_code,mercado) values ($codigo, $cant, $corr, $hasta, $hoy2, $hoy2, $id_etiquetados_folios,$bar_code,$sku,$mercado) ";

/* $sql_mod_eti="UPDATE etiquetas_agrosuper set id_cruce_tabla=$codigo, cantidad=$cant, desde=$corr, hasta=$hasta, fecha_emision=$hoy2, fhoy=$hoy2 where id_etiquetas_unidad=1 ";*/

$result_nuevo=mysql_query($sql_mod_eti,$link);
} 
...
<BODY OnLoad="document.form1.dato.focus()";>
<form onSubmit = "return isMailReady(this);" id="form1folios" name="form1" method="post" action="">
  ...
  <? if($cuantos){?>
    ...
    $f_recepcion=format_fecha_sin_hora($row[f_recepcion]);     
	 ...
	 // $id_caract_envases=$row[id_caract_envases];
	  $id_pedidos=$row[id_pedidos];
	   $fech_generada_inicio22=$row[fech_generada_inicio];
          ...
          <tr>
            <td><table border="0" align="center">
              <tr>
                ...
                <td><div align="center"><span class="numero">A&Ntilde;O <? echo substr($row[ano],0,4); ?> FOLIO <?echo $row[folio_m3]?>
...
<?if($codigo == 534 or $codigo == 535 or $codigo == 536 or $codigo == 537 or $codigo == 538 or $codigo == 539 or $codigo == 540 or $codigo == 541 or $codigo == 542 or $codigo == 593 or $codigo == 594 or $codigo == 595 or $codigo == 596 or $codigo == 597 or $codigo == 609 or $codigo == 610 or $codigo == 611 or $codigo == 642 or $codigo == 643){?> 


<tr align="center">
    
<td><div align="center">
<a href="javascript:Abrir_ventana('etiquetas_folios_print222221.php?id_etiquetados_folios=<?echo $row[id_etiquetados_folios]?>')"><img src="jpg/impresora.jpg" width="35" height="39" border="0" /></a><span class="titulo"><br> Imprimir Folio</span></div></td> 

<td><div align="center">
<a href="javascript:Abrir_ventana('etiquetas_folios_reprint.php?id_etiquetados_folios=<?echo $row[id_etiquetados_folios]?>')"><img src="jpg/printer.png" width="35" height="39" border="0" /></a><span class="titulo"><br/>Reemprimir Folio</span></div></td>

<?}else{?>

<td><div align="center">
<a href="javascript:Abrir_ventana('etiquetas_folios_print22222.php?id_etiquetados_folios=<?echo $row[id_etiquetados_folios]?>')"><img src="jpg/impresora.jpg" width="35" height="39" border="0" /></a><span class="titulo"><br/>Imprimir Folio</span></div></td>
...
<?if($codigo == 534 or $codigo == 535 or $codigo == 536 or $codigo == 537 or $codigo == 538 or $codigo == 539 or $codigo == 540 or $codigo == 541 or $codigo == 542 or $codigo == 593 or $codigo == 594 or $codigo == 595 or $codigo == 596 or $codigo == 597 or $codigo == 609 or $codigo == 610 or $codigo == 611 or $codigo == 642 or $codigo == 643 and $permiso34 == 1 and $nivel_usua == 1){?>

                <div align="right" class="titulo">Correlativo:&nbsp;<input type="text" name="corr" size="4" value="<?echo $hasta?>" /></div>
                <div align="right" class="titulo">Cantidad:&nbsp;<input type="text" name="cant" size="4" value="<?echo $cantidad?>" /></div>
                <div align="right" class="titulo">Mercado:&nbsp;<select id="mercado" name="mercado" style="width: 80px" >
                      <option value="0">Sudamerica</option>
                      <option value="1">Europa</option>
                </select></div>  
                <div align="center"><input type="submit" name="cambiar" value="Actualizar"></div>
...
<!--  ********************************************** -->
	   ...
	   // if($row[id_producto]){
		...
		//echo $calibre;
		 //  }
		  ?></td>
    <!-- modificacion nombre alternativo-->  
      <? if($permiso34 == 1 and $nivel_usua == 1){ ?>
...
<tr>
                <td width="141" class="titulo">
                      Fecha de Recepci&oacute;n </td>

            <td width="152">
          
             <?if(!$f_recepcion){ 
              $fechar=date("Y-m-d"); 
              $fecharr=format_fecha_sin_hora($fechar);
              $fecha_rec=$fecharr;  
            ?>
                        
            <input name="f_recepcion" type="text" class="cajas" value="<?echo $fecha_rec?>" size="10" maxlength="10" />
            <? }else{?>
            <input name="f_recepcion" type="text" class="cajas" value="<?echo $f_recepcion?>" size="10" maxlength="10" />
            <? }?>
                       
            <a href="javascript:show_Calendario('form1.f_recepcion');" class="cajas" >Ver</a></td>                      
</tr>
<!-- *******************************************  -->
                    <tr>
...
if ($codigo == 534 or $codigo == 535 or $codigo == 536 or $codigo == 537 or $codigo == 538 ) {
  $dat1ven=split(" ",$f_elaboracion);
}else{
...
//             $dat1ven=split(" ",$f_termino);
				...
				?>
					  ...
					  <? if(($row[id_procedencia] == 'N' or $row[id_procedencia] == 'R') and $codigo != 181 and $codigo != 220 and $codigo != 201 and $codigo != 202 and $codigo != 203 and $codigo != 204 and $codigo != 197  and $codigo != 205){?>
                        <div align="center"> <a href="javascript:Abrir_ventana('ver_trazabilidad.php?id_etiquetados_folios=<?echo $row[id_etiquetados_folios]?>&amp;f_elaboracion=<? echo $f_elaboracion?>&amp;f_termino=<? echo $f_termino?>&amp;id_producto=<? echo $row[id_producto]?>&valor_indice=<? echo $valor_indice?>&id_tipo_calculo=<? echo $id_tipo_calculo?>&m3_cod=<? echo $row[folio_m3]?>')"><img src="jpg/trazabalidad3.jpg" width="62" height="36" border="0" /></a></div>
                       <? } ?>
                      <? if($row[id_procedencia] == 'N' and $codigo == 181 or $codigo == 220){?>
                            <div align="center"> <a href="javascript:Abrir_ventana('ver_trazabilidad_mucosa.php?id_etiquetados_folios=<?echo $row[id_etiquetados_folios]?>&amp;f_elaboracion=<? echo $f_elaboracion?>&amp;f_termino=<? echo $f_termino?>&amp;id_producto=<? echo $row[id_producto]?>&valor_indice=<? echo $valor_indice?>&id_tipo_calculo=<? echo $id_tipo_calculo?>&factura_trazab=<? echo $factura_trazab?>&guia_despacho_trazab=<? echo $guia_despacho_trazab?>')"><img src="jpg/trazabalidad3.jpg" width="62" height="36" border="0" /></a></div>
                       <? } ?>
                        <? if($row[id_procedencia] == 'N' and $codigo == 201 or $codigo == 202 or $codigo == 203 or $codigo == 204 or $codigo == 197  or $codigo == 205){?>
                            <div align="center"> <a href="javascript:Abrir_ventana('ver_trazabilidad_grasa.php?id_etiquetados_folios=<?echo $row[id_etiquetados_folios]?>&amp;f_elaboracion=<? echo $f_elaboracion?>&amp;id_producto=<? echo $row[id_producto]?>&valor_indice=<? echo $valor_indice?>&id_tipo_calculo=<? echo $id_tipo_calculo?>&guia_despacho=<? echo $guia_despacho?>')"><img src="jpg/trazabalidad3.jpg" width="62" height="36" border="0" /></a></div>
                       <? } ?>
                       <?
					  if($row[id_procedencia] == 'I'){
					  ?>
                        <div align="center"> <a href="javascript:Abrir_ventana_importada('ver_trazabilidad_importada.php?id_etiquetados_folios=<?echo $row[id_etiquetados_folios]?>')"><img src="jpg/trazabalidad3.jpg" width="62" height="36" border="0" /></a></div	
					  >
                        <? }?></td>
                    </tr>
                    <tr>
                      ...
                      <td class="numero">
                  	    ...
                  	    <span class="titulo"><? if($codigo != 201 and $codigo != 202 and $codigo != 203 and $codigo != 204 and $codigo != 197  and $codigo != 205){?>
		...
		echo $operarios;?></td>
              ...
              <input name="id_estado_folio" type="hidden" value="<?echo $row[id_estado_folio]?>" />
					...
					<? if($cuantosimp){?>
                  <tr>
                    <td width="141"><span class="titulo">Procedencia</span></td>
                  ...
                  <tr>
                    <td colspan="5" bgcolor="#CCCCCC"><span class="titulo">Producto Ingresado por el Usuario</span></td>
                    <td colspan="2" align="left" bgcolor="#CCCCCC" class="titulo">Producto de Muestra</td>
                  </tr>
                  <tr>
                    <td colspan="5">	<?
	  ...
	  $cuantosusuario=mysql_num_rows($resultusuario);
	 
      if($rowusu=mysql_fetch_array($resultusuario))
      { 
	  $usernamerowusu=$rowusu[username];
	  ...
	  // if ($id_producto) {
		...
		echo $origen;
              ...
              <tr>
                ...
                <? }?>
                <? if($codigonuevo == 201 or $codigonuevo == 202 or $codigonuevo == 203 or $codigonuevo == 204 or $codigonuevo == 197 or $codigonuevo == 205){?>
                <table width="584" border="0" cellpadding="0" cellspacing="0">
                  <tr>
...
<!-- *******************************************  -->
                    ...
                    <tr>
                      ...
                      <td><? 
          					   ...
          					   $fecd=$datven[0];
            				    $fecha_ven="$datven[1]";
          					  ?>                        <? //echo "$fecd-$fecha_ven-$fech";?>
                      </td>
                      <td width="131"></td>
                      <td width="158">
                        <? if($id_procedencia == "N" and $id_especie and $id_operarios != 0 and $id_producto != 0 and  $id_calibre != 0 and $id_medidas_productos != 0 and $id_envases != 0 and $contenido_unidades and $codigonuevo != 181 and $codigonuevo != 220 and $codigonuevo != 201 and $codigonuevo != 202 and $codigonuevo != 203 and $codigonuevo != 204  and $codigonuevo != 205){?>
                        
                        <div align="center"><a href="javascript:Abrir_ventana('insertar_trazabilidad.php?id_etiquetados_folios=<?echo $s?>&amp;f_recepcion=<? echo $f_recepcion?>&amp;f_elaboracion=<? echo $f_elaboracion?>&amp;f_termino=<? echo $f_termino;?>&amp;codigonuevo=<? echo $codigonuevo?>&amp;id_especie=<? echo $id_especie?>&amp;id_unidad_medida=<? echo $id_unidad_medida?>&amp;id_caract_producto=<? echo $id_caract_producto?>&amp;id_caract_envases=<? echo $id_caract_envases?>&amp;id_producto2=<? echo $id_producto?>&amp;id_calibre=<? echo $id_calibre?>&amp;id_medidas_productos=<? echo $id_medidas_productos?>&amp;id_envases=<? echo $id_envases?>&amp;f_inicio=<?echo $f_inicio?>&amp;fecha_ven=<? echo "$fecd-$fecha_ven-$fech";?>&amp;id_operarios=<? echo $id_operarios?>&amp;contenido_unidades=<? echo $contenido_unidades?>&amp;id_procedencia=<? echo $id_procedencia?>&amp;valor_indice2=<? echo $valor_indice_tabla?>&amp;id_tipo_calculo2=<? echo $id_tipo_calculo_tabla?>&factura_trazab=<? echo $factura_trazab?>&guia_despacho_trazab=<? echo $guia_despacho_trazab?>&gpallet=<? echo $gpallet?>&cantidad_foliosgenerar=<? echo $cantidad_foliosgenerar?>&id_insuban=<? echo $id_insuban?>')" class="titulo"><img src="jpg/trazabalidad.jpg" border="0" /></a></div>
                        <? } ?>
                       ...
                       <div align="center"><a href="javascript:Abrir_ventana('insertar_trazabilidad_grasa.php?id_etiquetados_folios=<?echo $s?>&amp;f_elaboracion=<? echo $f_elaboracion?>&amp;codigonuevo=<? echo $codigonuevo?>&amp;id_especie=<? echo $id_especie?>&amp;id_unidad_medida=<? echo $id_unidad_medida?>&amp;id_caract_producto=<? echo $id_caract_producto?>&amp;id_caract_envases=<? echo $id_caract_envases?>&amp;id_producto2=<? echo $id_producto?>&amp;id_calibre=<? echo $id_calibre?>&amp;id_medidas_productos=<? echo $id_medidas_productos?>&amp;id_envases=<? echo $id_envases?>&amp;id_operarios=<? echo $id_operarios?>&amp;contenido_unidades=<? echo $contenido_unidades?>&amp;id_procedencia=<? echo $id_procedencia?>&amp;valor_indice2=<? echo $valor_indice_tabla?>&amp;id_tipo_calculo2=<? echo $id_tipo_calculo_tabla?>&n_bandeja=<? echo $n_bandeja?>&guia_despacho=<? echo $guia_despacho?>&id_origen=<? echo $id_origen?>&id_insuban=<? echo $id_insuban?>')" class="titulo"><img src="jpg/trazabalidad.jpg" border="0" /></a></div>
                        ...
                        <div align="center"><a href="javascript:Abrir_ventana('insertar_trazabilidad_importada.php?id_etiquetados_folios=<?echo $s?>&amp;f_recepcion=<? echo $f_recepcion?>&amp;f_elaboracion=<? echo $f_elaboracion?>&amp;f_termino=<? echo $f_termino;?>&amp;codigonuevo=<? echo $codigonuevo?>&amp;id_producto2=<? echo $id_producto?>&amp;id_calibre=<? echo $id_calibre?>&amp;id_medidas_productos=<? echo $id_medidas_productos?>&amp;id_especie=<? echo $id_especie?>&amp;id_unidad_medida=<? echo $id_unidad_medida?>&amp;id_caract_producto=<? echo $id_caract_producto?>&amp;id_caract_envases=<? echo $id_caract_envases?>&amp;id_envases=<? echo $id_envases?>&amp;id_origen=<? echo $id_origen?>&amp;compro_nro=<? echo $compro_nro?>&amp;f_inicio=<?echo $f_inicio?>&amp;fecha_ven=<? echo "$fecd-$fecha_ven-$fech";?>&amp;id_operarios=<? echo $id_operarios?>&amp;contenido_unidades=<? echo $contenido_unidades?>&amp;factura_importada=<? echo $factura_importada?>&amp;id_procedencia=<? echo $id_procedencia?>&amp;bidon_importado=<? echo $bidon_importado?>&id_usuario=<? echo $id_insuban?>')" class="titulo"><img src="jpg/trazabalidad.jpg" border="0" /></a></div>
                        <? }?></td>
                    </tr>
                </table></td>
              </tr>
             ...
             <? if($id_caract_producto == 25 or $codigonuevo == 404 or $codigonuevo == 411 or $codigonuevo == 412 or $codigonuevo == 386 or $codigonuevo == 393 or $codigonuevo == 387 or $codigonuevo == 376 or $codigonuevo == 374 or $codigonuevo == 425 or $codigonuevo == 426 or $codigonuevo == 427 or $codigonuevo == 428 or $codigonuevo == 429 or $codigonuevo == 375 or $codigonuevo == 438 or $codigonuevo == 439 or $codigonuevo == 440 or $codigonuevo == 441 or $codigonuevo == 443 or $codigonuevo == 442 or $codigonuevo == 444 or $codigonuevo == 406 or $codigonuevo == 445 or $codigonuevo == 446 or $codigonuevo == 453 or $codigonuevo == 454 or $codigonuevo == 384 or $codigonuevo == 281 or $codigonuevo == 282 or $codigonuevo == 158 or $codigonuevo == 456 or $codigonuevo == 157 or $codigonuevo == 457 or $codigonuevo == 458 or $codigonuevo == 459 or $codigonuevo == 460 or $codigonuevo == 462 or $codigonuevo == 463 or $codigonuevo == 465 or $codigonuevo == 466 or $codigonuevo == 467 or $codigonuevo == 468 or $codigonuevo == 469 or $codigonuevo == 448 or $codigonuevo == 470 or $codigonuevo == 472 or $codigonuevo == 476 or $codigonuevo == 197 or $codigonuevo == 477 or $codigonuevo == 481 or $codigonuevo == 482 or $codigonuevo == 483 or $codigonuevo == 484 or $codigonuevo == 473 or $codigonuevo == 474 or $codigonuevo == 475 or $codigonuevo == 485 or $codigonuevo == 461 or $codigonuevo == 487 or $codigonuevo == 490 or $codigonuevo == 491 or $codigonuevo == 492 or $codigonuevo == 493 or $codigonuevo == 494 or $codigonuevo == 495 or $codigonuevo == 496 or $codigonuevo == 497 or $codigonuevo == 498 or $codigonuevo == 499 or $codigonuevo == 500 or $codigonuevo == 177 or $codigonuevo == 478 or $codigonuevo == 502 or $codigonuevo == 503 or $codigonuevo == 504 or $codigonuevo == 508 or $codigonuevo == 510 or $codigonuevo == 511 or $codigonuevo == 512 or $codigonuevo == 516 or $codigonuevo == 509 or $codigonuevo == 518 or $codigonuevo == 517 or $codigonuevo == 299 or $codigonuevo == 519 or $codigonuevo == 520 or $codigonuevo == 521 or $codigonuevo == 522 or $codigonuevo == 523 or $codigonuevo == 524 or $codigonuevo == 531 or $codigonuevo == 532 or $codigonuevo == 461 or $codigonuevo == 529 or $codigonuevo == 530 or $codigonuevo == 428){?>
                  <tr>
                    ...
                    <td width="251"><input name="cantidad_foliosgenerar" type="text" disabled id="cantidad_foliosgenerar" value="<?echo $cantidad_foliosgenerar?>" size="5" maxlength="2"/><? //echo "gpallet $gpallet - cantidad_folios $cantidad_foliosgenerar";?></td>
                  </tr>
