...
<table width="901" height="201" border="0" align="center">
  ...
  <tr>
    <td height="4" colspan="2" valign="top" class="cajas"><div align="right"><a href="?modulo=pedido_modificar_h.php&id_ped=<? echo $id_ped?>">Volver</a></div></td>
  </tr>
  <tr>
...
<!--		<? if($permiso47 == 1 and $nivel_usua == 1){?>
        ...
        <td width="70" nowrap="NOWRAP" bgcolor="#CCCCCC" class="titulo"><div align="left">Procedencia</div></td>
...
<!--		<? if($permiso47 == 1 and $nivel_usua == 1){?>
        ...
        <td nowrap="nowrap" bgcolor="<? echo $color?>" class="cajas"><div align="center">&nbsp;<a href="?modulo=ejemplo_etiquetas_folios.php&amp;id_etf2=<?echo $row[id_etiquetados_folios]?>&amp;id_pedi=<? echo $id_ped?>&amp;id_destinosv=<? echo $id_destinosv?>&amp;fecha_prioridad=<? echo $fecha_prioridad?>"><?echo $row[id_etiquetados_folios]?></a></div></td>
        <td align="center" nowrap="nowrap" bgcolor="<? echo $color?>" class="cajas">&nbsp;<? 
echo "$pallet";
 
?>
          <div align="center"></div></td>
        <td nowrap="nowrap" bgcolor="<? echo $color?>" class="cajas">&nbsp;<a href="?modulo=ejemplo_etiquetas_folios.php&id_etf2=<?echo $row[id_etiquetados_folios]?>&id_pedi=<? echo $id_ped?>&id_destinosv=<? echo $id_destinosv?>&fecha_prioridad=<? echo $fecha_prioridad?>"><? echo $row[producto];?></a>
  ...
  <tr>
	...
	?>
      ...
      <td nowrap="nowrap" class="cajas">&nbsp;<? echo $id_etiquetados_folios2?>
