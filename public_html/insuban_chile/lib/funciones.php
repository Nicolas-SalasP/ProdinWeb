...
{
$estado="<select name=\"id_estado\" class=\"cajas\" style=\"width:180px\">\n";
...
function crea_estado_onchange($link,$id_estado)//funcion crea estado de material
{
$estado="";

$estado="<select name=\"id_estado\" onchange=\"JavaScript:document.form1.submit();\">\n";
...
{
$funcion_operarios="<select name=\"id_funcion_operarios\" class=\"cajas\" style=\"width:180px\">\n";
$sql="select * from funcion_operarios";
$result=mysql_query($sql,$link);
$funcion_operarios.="<option value=\"0\">Seleccione Funcion</option>\n";
while ($row=mysql_fetch_array($result))
{ 
...
$sql="select * from producto AS pro, cruce_plant_calibre AS cpc where pro.id_producto = cpc.id_producto and pro.id_producto != 0 and pro.id_producto != 88 and pro.id_estado = 1 GROUP BY pro.id_producto";
$result=mysql_query($sql,$link);
$producto.="<option value=\"0\">Seleccione Producto</option>\n";
while ($row=mysql_fetch_array($result))
{ 
...
$sql="select * from estado_folio where id_estado_folio != 8 and id_estado_folio != 4 and id_estado_folio != 11 and id_estado_folio != 0 and id_estado_folio != 9 and id_estado_folio != 10 and id_estado_folio != 6 and id_estado_folio != 5 and id_estado_folio != 7 and id_estado_folio != 3";

//$sql="select * from estado_folio where id_estado_folio != 9 and id_estado_folio != 7 and id_estado_folio != 11 and id_estado_folio != 0";
...
function crea_grupo_personas($link,$id_grupo)//funcion crea estado de material
{
$grupo="";
$grupo="<select name=\"id_grupo\" class=\"cajas\">\n";

$sql="select * from grupo";
$result=mysql_query($sql,$link);
$grupo.="<option value=\"0\">Grupo</option>\n";
while ($row=mysql_fetch_array($result))
{ 
if ($id_grupo==$row[id_grupo])
$grupo.="<option value=\"$row[id_grupo]\" selected>$row[grupo]</option>\n";
else
$grupo.="<option value=\"$row[id_grupo]\">$row[grupo]</option>\n";
} 
$grupo.="</select>\n";
return $grupo;
}
...
function crea_estado_folio_selectdos_new($link,$id_estado_folio)//funcion crea estado de material
{
$estado_folio="";
$estado_folio="<select name=\"id_estado_folio\" class=\"cajas\" onchange=\"JavaScript:document.form1.submit();\">\n";

$sql="select * from estado_folio where id_estado_folio != 8 and id_estado_folio != 4 and id_estado_folio != 10 and id_estado_folio != 6 and id_estado_folio != 5 and id_estado_folio != 3 and id_estado_folio != 9 and id_estado_folio != 7 and id_estado_folio != 11 and id_estado_folio != 0";
$result=mysql_query($sql,$link);
$estado_folio.="<option value=\"0\">Estado Folio</option>\n";
while ($row=mysql_fetch_array($result))
{ 
...
{
$destinos.="<option value=\"$row2[id_destinos]\" selected>$row2[destinos] $row2[id_M3_destino]</option>\n";
...
function crea_destinos($link,$id_destinos,$id_M3_destino)
{
$destinos="<select name=\"id_destinos\" class=\"cajas\" style=\"width:180px\">\n";
$sql="select * from destinos where id_destinos != 0 and id_M3_destino !=0 order by destinos";
$result=mysql_query($sql,$link);
$destinos.="<option value=\"0\">Destinos</option>\n";
while ($row=mysql_fetch_array($result))
{ 
...
$destinos.="<option value=\"$row[id_destinos]\" selected>$row[destinos].$row[id_M3_destino]</option>\n";
else
$destinos.="<option value=\"$row[id_destinos]\">$row[destinos].$row[id_M3_destino]</option>\n";
} 
$destinos.="</select>\n";
return $destinos;
}
...
AND ef.id_estado_folio between 7 and 12
...
if(!$onchange){
$operarios="<select name=\"id_operarios\" class=\"cajas\" style=\"width:150px\">\n";
}else{
$operarios="<select name=\"id_operarios\" class=\"cajas\" style=\"width:150px\" onChange=\"JavaScript:document.form1.submit();\">\n";
}
...
$operarios="<select name=\"id_operarios\" style=\"width:250px\" class=\"cajas\">\n";
$sql="select * from operarios where id_estado = 1  order by nombreop desc";
$result=mysql_query($sql,$link);
$operarios.="<option value=\"0\">Seleccione Operario</option>\n";
...
$sql="select * from estado_folio where id_estado_folio != 0 and id_estado_folio != 11";
$result=mysql_query($sql,$link);
...
{
if(!$onchange){
$procedencia="<select name=\"id_procedencia\" class=\"cajas\" style=\"width:90px\">\n";
}else{
$procedencia="<select name=\"id_procedencia\" class=\"cajas\" style=\"width:90px\" onChange=\"JavaScript:document.form1.submit();\">\n";
}
$sql="select * from procedencia where id_procedencia = 'N'";
$result=mysql_query($sql,$link);
...
function crea_procedencia222222($link,$id_procedencia,$onchange)// funcion crea Procedencia
{
if(!$onchange){
$procedencia="<select name=\"id_procedencia\" class=\"cajas\" style=\"width:90px\">\n";
}else{
...
$especie="";
if(!$onchange){
$especie="<select name=\"id_especie-$id_cruce_tablas\" class=\"cajas\" style=\"width:70px\">\n";
}else{
$especie="<select name=\"id_especie\" class=\"cajas\" style=\"width:70px\" onChange=\"JavaScript:document.form1.submit();\">\n";
}
...
$producto_calibre="";
if(!$onchange){
$producto_calibre="<select name=\"id_calibre-$id_cruce_tablas\" class=\"cajas\" style=\"width:190px\">\n";
}else{
$producto_calibre="<select name=\"id_calibre\" class=\"cajas\" style=\"width:190px\" onChange=\"JavaScript:document.form1.submit();\">\n";
}
...
$producto_medida="";
if(!$onchange){
$producto_medida="<select name=\"id_medidas_productos-$id_cruce_tablas\" class=\"cajas\" style=\"width:70px\">\n";
}else{
...
if(!$onchange){
$producto_caract_producto="<select name=\"id_caract_producto-$id_cruce_tablas\" class=\"cajas\" style=\"width:180px\">\n";
}else{
$producto_caract_producto="<select name=\"id_caract_producto\" class=\"cajas\" style=\"width:90px\" onChange=\"JavaScript:document.form1.submit();\">\n";
}
...
if(!$onchange){
$producto_caract_envases="<select name=\"id_caract_envases-$id_cruce_tablas\" class=\"cajas\" style=\"width:180px\">\n";
}else{
$producto_caract_envases="<select name=\"id_caract_envases\" class=\"cajas\" style=\"width:80px\" onChange=\"JavaScript:document.form1.submit();\">\n";
}
...
if(!$onchange){
$producto_unidad_medida="<select name=\"id_unidad_medida-$id_cruce_tablas\" class=\"cajas\" style=\"width:180px\">\n";
}else{
$producto_unidad_medida="<select name=\"id_unidad_medida\" class=\"cajas\" style=\"width:100px\" onChange=\"JavaScript:document.form1.submit();\">\n";
}
...
if(!$onchange){
$calibre="<select name=\"id_calibre\" class=\"cajas\" style=\"width:80px\">\n";
}else{
$calibre="<select name=\"id_calibre\" class=\"cajas\" style=\"width:80px\" onChange=\"JavaScript:document.form1.submit();\">\n";
}
...
if(!$onchange){
$unidad_medida="<select name=\"id_unidad_medida\" class=\"cajas\" style=\"width:80px\">\n";
}else{
$unidad_medida="<select name=\"id_unidad_medida\" class=\"cajas\" style=\"width:80px\" onChange=\"JavaScript:document.form1.submit();\">\n";
}
...
if(!$onchange){
$medidas_productos="<select name=\"id_medidas_productos\" class=\"cajas\" style=\"width:80px\">\n";
}else{
$medidas_productos="<select name=\"id_medidas_productos\" class=\"cajas\" style=\"width:80px\" onChange=\"JavaScript:document.form1.submit();\">\n";
}
...
if(!$onchange){
$caract_producto="<select name=\"id_caract_producto\" class=\"cajas\" style=\"width:80px\">\n";
}else{
$caract_producto="<select name=\"id_caract_producto\" class=\"cajas\" style=\"width:80px\" onChange=\"JavaScript:document.form1.submit();\">\n";
}
...
if(!$onchange){
$caract_envases="<select name=\"id_caract_envases\" class=\"cajas\" style=\"width:60px\">\n";
}else{
$caract_envases="<select name=\"id_caract_envases\" class=\"cajas\" style=\"width:60px\" onChange=\"JavaScript:document.form1.submit();\">\n";
}
...
$sql="SELECT * FROM destinos where id_etiqueta_idioma = $id_etiqueta_idioma and id_estado =1 order by destinos asc";
$result=mysql_query($sql,$link);
