...
$sql2="SELECT * FROM paking AS p, etiquetados_folios As ef, calibre AS c, producto AS pro, medidas_productos AS mp 
...
<!--    <td class="style7"><?echo $r[folio_m3]?></td> -->   
  ...
  <tr>
    <td>&nbsp;</td>
<? if ( $id_destinos == 104 ){ ?> <td height="21" class="style7">N&ordm; de Lote </td> <?}else{?>
...
<? if ($id_destinos == 104) { ?>
  <tr>
    <td>&nbsp;</td>
    <td height="19" class="style7">Peso Neto</td>
    <td class="style7">:</td>
<!--     <td class="style7"><?echo $r[medidas_productos]?></td>  -->
<!--   <td class="style7"><? echo $contenido_unidades=$r[contenido_unidades]; ?> Kls.</td> -->
    <td class="style7"><? echo $peso2_alt;?> Kls.</td>   
  </tr>
<?}?>
...
<tr>
    <td>&nbsp;</td>
<?if ($id_destinos == 104) {?> <td height="19" class="style7">Fecha de Faena </td> 
    <td class="style7">:</td>
    <td class="style7"><? 
  ...
  <tr>
    <td>&nbsp;</td>
<?if ($id_destinos == 104) {?> <td height="19" class="style7">Fecha de Empaque </td> <?}else{?>  
    <td height="19" class="style7">Fecha de Elaboraci&oacute;n </td><?}?>
    <td class="style7">:</td>
    <td class="style7"><? 

if ($id_destinos == 210 or $id_destinos == 189 or $id_destinos == 104 or $id_destinos == 3 or $id_destinos == 396 or $id_destinos == 276 or $id_destinos == 64 or $id_destinos == 186 or $id_destinos == 176 or $id_destinos == 6 or $id_destinos == 307 ) {
...
// Modificicacion solicitada por Calidad Paulina 01122020
  ...
  echo "<tr>";
  echo "<td>&nbsp;</td>";
  if ($id_cruce_tablas == 298) {
    echo "<td colspan='4'><span class='cajas'>Ingredientes: Tripa de Vacuno, Agua, Sal.</span></td>";
  }else{
  ...
  <tr>
    ...
    <td height="50" colspan="4" valign="top" class="cajas">Mantener en Lugar Fresco y Seco a Temperatura Ambiente <?if ($id_destinos ==358 or $id_destinos ==396) {?> <br> Reg. Monografia MGAP/DGSG/DIA/M 1795<br> Reg. Rotulo MGAP/DGSG/DIA/R 1795 <?}?><?if ($id_destinos == 104 or $id_destinos == 3 ) {?><br>Ingredientes: Tripa de cerdo, agua, sal.<?}?> </td>       
<!--
...
<!--    <td class="style7"><?echo $r[medidas_productos]?></td> -->
  ...
  echo "<tr>";
  echo "<td>&nbsp;</td>";
  if ($id_destinos == 176 and $id_cruce_tablas == 298) {
    echo "<td colspan='4'><span class='cajas'> Ingredientes: Tripa de Vacuno, Agua, Sal.</span></td>";
  }else{
    echo "<td colspan='4'><span class='cajas'> Ingredientes: Tripa de Cerdo, Agua, Sal.</span></td>";
  }
  ...
  <tr>
    <td height="50" class="cajas">&nbsp;</td>
    <td height="50" colspan="4" valign="top" class="cajas">Mantener en Lugar Fresco y Seco a Temperatura Ambiente </td>
    <br>
  </tr>
</table>
