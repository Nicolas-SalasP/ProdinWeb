...
<table width="798" border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  $id_procedencia = $row[id_procedencia];    
	...
	?>
          ...
          echo $rowpik[folio_piking]; 
					$id_etiq_fo=$row[id_etiquetados_folios];
					}
					}					
					?></td>
                    <td nowrap="nowrap" bgcolor="#FFCC99" class="cajas">&nbsp;<? echo $row[folio_m3];?></td>
...
?>
                      <tr>
                        <td nowrap="nowrap" class="cajas">&nbsp;<? if(!$consultasbodegas) { echo $id_etiq_fo; }else{ echo $row[id_etiquetados_folios];}?></td>
                        ...
                        <td nowrap="nowrap" class="cajas">&nbsp;<? echo $r[origen];?></td>
...
<!--                    <td nowrap="nowrap" class="cajas">&nbsp;<? echo $r[comprobante_num];?></td>-->
                        <td nowrap="nowrap" class="cajas">&nbsp;<?echo $comp;?></td>
...
?>
	  	 ...
	  	 ?>
                        ...
                        <td nowrap="nowrap" class="cajas">&nbsp;<? echo $ri[origen];?></td>
