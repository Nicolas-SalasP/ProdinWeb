...
if($id_producto and !$id_producto2){
$sql.= " and p.id_producto = '$id_producto'";

}

if($id_producto2 and  !$id_producto){
	$sql.= " and p.id_producto = '$id_producto2'";
		...
		<table width="784" border="0" align="center">
            <tr>
              <td colspan="2"><table width="752" border="0">
				...
				?>
				  ...
				  ?></td>
                  <td width="258" align="center" bgcolor="#FF9900"><a href="?modulo=informes_diarios.php" class="style3">Resumen Inventario</a></td>
                  </tr>
              </table></td>
              </tr>
            <tr>
              <td colspan="2" class="titulo"><table width="752" border="0">
                <tr>
                  ...
                  <td width="165" bgcolor="#FF9900">&nbsp;<input name="piking" type="text" class="cajas" id="piking" size="17" value="<? echo $piking ?>" />
                  </td>
                  <td width="169" bgcolor="#999999" class="titulo">&nbsp;Factura Venta N/I</td>
            ...
            <tr>
              <td colspan="2" class="titulo"><table width="752" border="0">
                ...
                <tr>
                  ...
                  <td width="168" bgcolor="#999999" class="titulo">&nbsp;Factura Importada:</td>
            ...
            <tr>
              <td colspan="2" class="titulo"><table width="752" border="0">
                ...
                <tr>
                  <td width="141" bgcolor="#999999" class="titulo">&nbsp;N&ordm; Bid&oacute;n Importado</td>
                  <td width="166" bgcolor="#FF9900">&nbsp;<input name="bidon_importado" type="text" class="cajas" id="bidon_importado" size="17" value="<? echo $bidon_importado ?>" /></td>
...
Incluir Cajas </span></td>
			  ...
			  <table width="96%" border="1" align="center" cellpadding="0" cellspacing="0">
				  ...
				  ?></td>
                    ...
                    <td width="37" height="14" nowrap="NOWRAP" bgcolor="#CCCCCC" class="titulo"><? //$producto=crea_producto_filtro($link,$id_producto,1); echo $producto;?>
                      <? 
					  $producto= crea_producto_onChange_segunestado($link,$id_estado_folio,$id_producto2);
				  	  echo $producto;
					  ?></td>
		...
		?></td>
                    ...
                    <td width="25" nowrap="NOWRAP" bgcolor="#CCCCCC" class="titulo">&nbsp;</td>
