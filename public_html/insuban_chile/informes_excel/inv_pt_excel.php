     	 ...
     	 if($cuantos){
		   while ($r=mysql_fetch_array($rest)){ 
            	...
            	$f_elaboracion =format_fecha_sin_hora($r[f_elaboracion]);
                  ...
                  $freprocesado =format_fecha_sin_hora($r[freprocesado]);
                  $guia =$r[guia];
                  $factura =$r[factura];
