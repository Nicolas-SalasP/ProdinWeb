...
<table width="778" height="106" border="0" align="center">
  ...
  <?      if(!$id_estado_folio){
		$estado_folio= crea_estado_folio_selectdos_new($link,1);
		echo $estado_folio;
		}else{
		$estado_folio= crea_estado_folio_selectdos_new($link,$id_estado_folio);
		echo $estado_folio;	
		}
  ...
  <tr>
	...
	<table width="800" border="1" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="39" nowrap="nowrap" bgcolor="#CCCCCC" class="titulo">&nbsp;&nbsp;Responsable</td>
        <td width="39" nowrap="nowrap" bgcolor="#CCCCCC" class="titulo">Factura IMP</td>
