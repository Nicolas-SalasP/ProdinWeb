...
<table width="856" height="219" border="0" align="center">
  <tr>
	...
	<table width="625" border="1" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="21" colspan="6" bgcolor="#CCCCCC" class="titulo">&nbsp;Factura Importada:<span class="cajas"> <? echo $factura_importada?> Origen: <? echo $origen?></span></td>
        </tr>
      <tr>
        <td width="20" height="21" align="center" bgcolor="#CCCCCC" class="titulo">N</td>
        <td width="132" height="21" align="center" bgcolor="#CCCCCC" class="titulo">Codigo Producto</td>
        <td width="95" align="center" bgcolor="#CCCCCC" class="titulo"> Cant. Bidones </td>
        <td width="96" align="center" bgcolor="#CCCCCC" class="titulo">Contenido</td>
        <td width="154" align="center" bgcolor="#CCCCCC" class="titulo">Costo  PL (Moneda Chilena)</td>
        <td width="114" align="center" bgcolor="#CCCCCC" class="titulo">Total Contenido</td>
        </tr>
<?
	...
	?>
      ...
      <tr>
		...
		<? echo $row[id_cruce_tablas]?>
        <input type="hidden" name="id_cruce_tablas-<? echo $id_cruce_tablasid?>" id="id_cruce_tablas" value="<? echo $id_cruce_tablasid?>" />
        </td>
        <td align="center" class="cajas">
		<? 
		...
		?>
        <input type="hidden" name="cantidad_bidones-<? echo $id_cruce_tablasid?>" id="cantidad_bidones" value="<? echo $cantidad_bidones?>" />
        </td>
        <td align="center" class="cajas">
      ...
      <tr>
        ...
        <td height="21" align="center" bgcolor="#CCCCCC" class="titulo">Totales</td>
      ...
      <tr>
        <td height="21" colspan="6" align="left" class="cajas"><span class="titulo">Nota:</span> Para dejar costos sin valor debe ingresar N&deg;: 0.</td>
        </tr>
