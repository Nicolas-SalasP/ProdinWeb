...
$contenido_alt=$r[contenido_alt];
$contenido_unidades=$r[contenido_unidades];


    if ($contenido_alt == "")
      $contenido_alt=$contenido_unidades;
...
<table width="393" height="421" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
   ...
   <? echo $contenido_alt; ?><?if ($id_destinos != 311) {?>
    Ma&ccedil;os Envolt&oacute;rio Natural Salgado de Su&iacute;no<?}?> 

<!--       <? echo $contenido_alt; ?><?if ($id_destinos != 311) {?>
    Unidades Envolt&oacute;rio Natural Salgado de Su&iacute;no<?}?>-->
...
<!--    <td height="20">Descri&ccedil;&atilde;o</td>-->
    <td height="20">Composi&ccedil;&atilde;o</td> 

    <td>:</td>

<!--    <td height="20" colspan="2"> <? if($id_destinos != 130){?>Tripa Rizada de Cerdo Original 15mts<?}else{?> <?}?> </td>-->
  ...
  <tr>
    ...
    <td height="20">Produtor</td>

    <td>:</td>

    <td height="20" colspan="2">Procesadora Insuban Spa</td>
...
<? if ($id_destinos != 311) {?>
  <td height="20">Importador</td><?}else{?><td height="20">Consignatario</td><?}?>
    <td>:</td>

<? if ($id_destinos != 311) {?>

    <? if($id_destinos == 253 or $id_destinos == 331){?><td height="20" colspan="2">AIN GLOBAL Importação e Exportação Ltda Rua Dona Francisca, 8300 – Bloco 10 – Modulo C – Distrito Industrial
    CEP: 89.219-600, Joinville/SC Brasil<br>CNPJ 10.291.570/0001-31</td>
    <?}else{?><td height="20" colspan="2"><? echo $destinos?></td><? }?>
  </tr>
<!--
  <? if($id_destinos != 253 or $id_destinos != 331){?><tr>
  <td height="20">Comprador</td>
    <td>:</td>
  ...
  <tr>
    <td height="20">&nbsp;</td>
    <td>&nbsp;</td>
    <td height="20" colspan="2"><? echo $domicilio?>&nbsp;<?echo $ciudad?></td>
  </tr>

<?}else{?>

<td height="20" colspan="2">DAT Schaub Porto, Industria Alimentar SA
Fábrica do Alandroal Parque Industrial e tecnológico do Alandroal 
Rua de Vila Viçosa, 13 7250-155 Alandroal
</td>
<?}?>
-->
  <tr>
...
<? if ($id_destinos != 311) {?>
  ...
  <tr>
    ...
    <? if($id_destinos != 130 and $id_destinos != 14 and $id_destinos != 5 and $id_destinos != 132 and $id_destinos != 158 and $id_destinos != 253 and $id_destinos != 243 and $id_destinos != 282 and $id_destinos != 331)
	{
  	echo "SIF/DIPOA Sob n 002/13-62";
	}else{
	echo "SIF/DIPOA Sob n 001/13-62";	
	}?>
   </td>
  </tr>
<?}?>
...
if ($id_destinos == 14 or $id_destinos == 253 or $id_destinos == 331) {
  ...
  <tr>
    ...
    <td height="20"><? $dat3=split(" ",$f_termino);

      $dat=split("-",$dat3[0]);

     if ($id_destinos == 253 or $id_destinos == 14 or $id_destinos == 331)  {
     ...
     $dat[0]=$dat[0]+2;
	  ...
	  //cambio de duracion solicitado sr. LOrena A. 14.09.2015
	   if ($id_paking_relacion >= 72611)
	  {
	  	$dat[2] = $dat[2];
	  }
	  // Fin comentario
...
<?}?>
 ...
 <!--   <td height="15" colspan="4">Mantenha Em Local Seco e Arejado <br> 30 días de salgado <br> Conservar a Temperatura Ambiente (Até 35º C)</td> -->
