<div class="modal" id="modalUpdateEvento"  tabindex="-1" role="dialog">
  ...
  <form name="formEventoUpdate" id="formEventoUpdate" action="UpdateEvento.php" class="form-horizontal" method="POST">
    ...
    <div class="form-group">
      <label for="idEvento" class="col-sm-12 control-label"> Pedido</label>
      <div class="col-sm-10">
    ...
    <div class="form-group">
      <label for="notas" class="col-sm-12 control-label"> Observación</label>
      <div class="col-sm-10">
<!--      <input  class="form-control" name="notas" id="notas" /> -->
          <textarea class="form-control" name="notas" id="notas" rows="3" cols="50">$notas</textarea>
      </div>
    </div>
