...
//Moficacion 25/06/2019 para cristina v
for ($j=1; $j <= 2 ; $j++){
...
<!--    <td height="20">Composi&ccedil;&atilde;o</td> -->
    ...
    <td>:</td>
		...
		<td height="20" colspan="2"> <? if($id_destinos != 130){?><?echo $nombre_alt?><?}else{?> <?}?> </td>
...
-->
  ...
  <tr>
    ...
    <td height="20" colspan="2">PROCESADORA INSUBAN <? if($id_destinos == 253){?>LTDA<?}else{?>SPA<?}?> </td>
...
<? if ($id_destinos != 311) {?>
    ...
    <? if($id_destinos == 253){?><td height="20" colspan="2">AIN GLOBAL Importação e Exportação Ltda
    Rua Dona Francisca, 8300 – Bloco 10 – Modulo C – Distrito Industrial
    CEP: 89.219-600, Joinville/SC Brasil<br>CNPJ 10.291.570/0001-31</td>
    <?}else{?><td height="20" colspan="2"><? echo $destinos?></td><? }?>
  </tr>

  <? if($id_destinos == 253){?><tr>
...
<td height="20" colspan="2">DAT-SCHAUB PORTUGAL INDUSTRIA ALIMENTAR, S.A<br>RUA DO EIRADO, 350 4410-429 ARCOZELO VNG PORTUGAL
</td>
<?}?>
  ...
  <tr>
    ...
    <td>:</td>
    <td height="20" colspan="2"><? echo $num;?>&nbsp; / &nbsp;<? echo $hasta;?></td> 
  </tr>
...
<? if ($id_destinos != 311) {?>
  ...
  <tr>
    ...
    <? if($id_destinos != 130 and $id_destinos != 14 and $id_destinos != 5 and $id_destinos != 132 and $id_destinos != 158 and $id_destinos != 253 and $id_destinos != 243 and $id_destinos != 282)
	{
...
<?}?>
  <tr>
    ...
    <td width="150" rowspan="2"><img src="jpg/NR1362.jpg" width="128" height="73" /></td>
        <tr>
  ...
  <tr>
    ...
    <td>:</td>
     ...
     <td height="20"><? $dat3=split(" ",$f_vencimiento);
	  ...
	  //cambi de duracion solicitado sr. LOrena A. 14.09.2015
