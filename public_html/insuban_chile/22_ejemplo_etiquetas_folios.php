...
if (document.form1.f_elaboracion.value == "") {     
    alert('Ingresar Fecha Elaboraci�n');
    document.form1.f_elaboracion.onfocus;
    return false;
}
...
var borrar = confirm("Est�s seguro/a de que desea eliminar el registro?"); 
...
<? }
		...
		echo $operarios;?><? echo $operarios;?></td>
		...
		echo $operarios;?></td> -->
              ...
              <tr>
                ...
                <? }else{ ?>
                <? echo "Asignado al Pallet N� $row[pallet]"; ?>
                <? }?>
