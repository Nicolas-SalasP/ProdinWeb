...
?>
	<?
		...
		?>
<table width="393" height="399" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="355" height="23"><div align="center" class="numero">Procesadora Insuban Ltda.</div></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	/*	if($id_unidad_produccion){
		$sql="SELECT * FROM etiquetas_unidad AS eu, origenes AS orig where eu.id_origen='$id_origen'";
		$result=mysql_query($sql);
		$cuantos=mysql_num_rows($result);
		if ($row=mysql_fetch_array($result))
        {
		echo $row[cod_nombre_suc]; 
		}
		}*/
  ...
  <tr>
    <td height="92" valign="top" class="cajas">
    <div align="center">
    <? if ($radio == 1){?>
