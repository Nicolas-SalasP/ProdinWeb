	...
	<table width="180" height="25" border="0" align="right">
      <tr>
        <td width="205"><div align="right" class="cajas">
            ...
            Informes de Trazabilidad <a href="javascript:Abrir_ventana('informes_pdf/imprimir_informes_trazabilidad.php?id_paking_relacion=<?echo $id_paking_relacion?>&amp;cantifo=<? echo $ccccc?>&amp;factura=<? echo $row[factura] ?>&amp;id_destinos=<? echo $id_destinosotro?>&id=<? echo $id?> ')">PDF</a>/<a href="javascript:Abrir_ventana('informes_excel/imprimir_informes_trazabilidad_excel.php?id_paking_relacion=<?echo $id_paking_relacion?>')">Excel</a><? } ?>
            </div>
        </div></td>
      </tr>
      <tr>
