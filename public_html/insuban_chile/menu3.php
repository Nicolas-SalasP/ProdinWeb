...
<table width="657" border="0" align="center">
  <tr>
    ...
    <td width="158" valign="top"><table width="141" border="0" align="center">
      ...
      <tr>
        <td><? if($permiso51 != 3){?><a href="?modulo=producto_empresa_listar.php" class="style4">Asig Origenes al Producto</a><? }else{?>
          <span class="style4">Asig Origenes al Producto</span>          <? }?></td>
      </tr>
      <tr>
        <td><? if($permiso52 != 3){?><a href="?modulo=costo_materia_prima_listar.php"><img src="botones/asignar_costo_mpn_1.jpg" width="137" height="17" border="0" /></a><? }else{?><img src="botones/asignar_caract_envase2.jpg" width="137" height="17" border="0" /><? }?></td>
      </tr>
      <tr>
        <td><? if($permiso53 != 3){?><a href="?modulo=listar_factura_importada.php"><img src="botones/asignar_costo_prod_importado_1.jpg" width="137" height="17" border="0" /></a><? }else{?><img src="botones/asignar_costo_prod_importado_2.jpg" width="137" height="17" border="0" /><? }?></td>
      </tr>
      <tr>
        <td><? if($permiso54 != 3){?><a href="?modulo=informes_costos.php"><img src="botones/cierre_fecha_hora_1.jpg" width="137" height="17" border="0" /></a><? }else{?><img src="botones/cierre_fecha_hora_2.jpg" width="137" height="17" border="0" /><? }?></td>
      </tr>
      <tr>
        <td><? if($permiso55 != 3){?><a href="?modulo=listado_exportado_manager.php"><img src="botones/historial_exp_manager_1.jpg" width="137" height="17" border="0" /></a><? }else{?><img src="botones/historial_exp_manager_2.jpg" width="137" height="17" /><? }?></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
    ...
    <td width="163" valign="top"><table width="144" border="0" align="center">
      ...
      <tr>
        <td ><? if($permiso26 != 3){?><a href="?modulo=emision_fajas.php"><img src="botones/emision_fajas1.jpg" width="137" height="17" border="0" /></a><? }else{?><img src="botones/emision_fajas2.jpg" width="137" height="17" border="0" /><? }?></td>
      </tr>
      <tr>
        <td ><? if($permiso27 != 3){?><a href="?modulo=pallets_faja_ejemplo.php"><img src="botones/pallets_fajas1.jpg" width="137" height="17" border="0" /></a><? }else{?><img src="botones/pallets_fajas2.jpg" width="137" height="17" border="0" /><? }?></td>
      </tr>
      
      <tr>
        <td><? if($permiso28 != 3){?><a href="?modulo=emision_fajas.php"><img src="botones/bodegas_stok1.jpg" width="137" height="17" border="0" /></a><? }else{?><img src="botones/bodegas_stok2.jpg" width="137" height="17" border="0" /><? }?></td>
      </tr>
      
      <tr>
        <td ><? if($permiso29 != 3){?><a href="?modulo=picking_ver_pallet.php"><img src="botones/pallets_packing_list1.jpg" width="137" height="17" border="0" /></a><? }else{?><img src="botones/pallets_packing_list2.jpg" width="137" height="17" border="0" /><? }?></td>
      </tr>
      <tr>
        <td >&nbsp;</td>
      </tr>
      <tr>
        <td ><? if($permiso30 != 3){?><a href="?modulo=materia_prima_nacional.php"><img src="botones/materia_prima_nacional1.jpg" width="137" height="17" border="0" /></a><? }else{?><img src="botones/materia_prima_nacional2.jpg" width="137" height="17" border="0" /><? }?></td>
      </tr>
      <tr>
        <td ><? if($permiso31 != 3){?><a href="?modulo=salida_materia_prima_nacional.php"><img src="botones/salida_mpn1.jpg" width="137" height="17" border="0" /></a><? }else{?><img src="botones/salida_mpn2.jpg" width="137" height="17" border="0" /><? }?></td>
      </tr>
      <tr>
        <td ><? if($permiso32 != 3){?><a href="?modulo=materia_prima_importada.php"><img src="botones/materia_prima_importada1.jpg" width="137" height="17" border="0" /></a><? }else{?><img src="botones/materia_prima_importada2.jpg" width="137" height="17" border="0" /><? }?></td>
      </tr>
      <tr>
        <td ><? if($permiso33 != 3){?><a href="?modulo=salida_materia_prima_importada.php"><img src="botones/salida_mpi1.jpg" width="137" height="17" border="0" /></a><? }else{?><img src="botones/salida_mpi2.jpg" width="137" height="17" border="0" /><? }?></td>
      </tr>
      <tr>
      ...
      <tr>
        <td ><? if($permiso48 != 3){?><a href="?modulo=bodega_traspaso_pmi.php"><img src="botones/bodega_traspazo_mpi_1.jpg" width="137" height="17" border="0" /></a><? }else{?><img src="botones/bodega_traspazo_mpi_2.jpg" width="137" height="17" border="0"/><? } ?></td>
      </tr>
      <tr>
      ...
      <tr>
        <td >
          <? if($permiso47 != 3){?><a href="?modulo=pedido_listar.php"><img src="botones/armar_pedid_negro.jpg" width="137" height="17" border="0" /></a><? }else{?><img src="botones/armar_pedido_gris.jpg" width="137" height="17" border="0" /><? }?></td>
      </tr>
      <tr>
    ...
    <td width="155" valign="top"><table width="141" border="0" align="center">
      ...
      <tr>
        <td bgcolor="#CCCCCC" class="stylenegrita" >INVENTARIOS DIARIOS</td>
      </tr>
      <tr>
        <td ><span class="style4"><a href="?modulo=inventario_pt.php">Obterner inventario PT</a></span></td>
      </tr>
      <tr>
        <td ><span class="style4"><a href="?modulo=inventario_importado.php">Obtener inventario MPI</a></span></td>
      </tr>
      <tr>
        <td ><span class="style4"><a href="?modulo=inventario_mpn.php">Obtener inventario MPN</a></span></td>
      </tr>
      <tr>
