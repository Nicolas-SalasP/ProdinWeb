...
<table width="393" height="379" border="0">
  <tr>
    ...
    <td width="3">:</td>
    <td colspan="2" class="style7">PROCESADORA INSUBAN <?if ($id_destinos == 10) {
    	echo "LTDA";}else{echo "SPA"; }?></td>
  </tr>
  <tr>
    <td height="19">&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td height="19">N&ordm; of Package</td>
    <td>:</td>
    <td><? echo $bultos?></td>
...
<!--     <td width="83">30 mts.</td>      -->
  ...
  <tr>
    ...
    <!--<td height="40" colspan="4" class="cajas">Salted in VAcuum <br>Keep In Fresh and Dry Place at Temperature Not  
    More Than 25&ordm;C</td> -->
  </tr>
</table>
<? 
