...
//$i=0;
  	...
  	$dat1=split("-",$dat3[0]);
  	$f_vencimientof="$dat1[0]-$dat1[1]-$dat1[2]";

  	$dia="$dat1[0]";
  	$mes="$dat1[1]";
  	$ano="$dat1[2]"+2;

	$f_vencimientofo="$dia-$mes-$ano";
...
$pdf->AddPage('P',array(300,280));
		  ...
		  $pdf->SetY(67.0);$pdf->SetX(10.0);$pdf->SetFont('Arial','',10); $pdf->Cell(0,00,"Fecha de Recepción:");
		  $pdf->SetY(67.0);$pdf->SetX(185.0);$pdf->SetFont('Arial','b',10); $pdf->Cell(0,00,"$f_recepcion");		  
		  $pdf->SetY(80.0);$pdf->SetX(10.0);$pdf->SetFont('Arial','',10); $pdf->Cell(0,00,"Fecha de Elaboración:");
		  $pdf->SetY(80.0);$pdf->SetX(185.0);$pdf->SetFont('Arial','b',10); $pdf->Cell(0,00,"$f_elaboracion");
		  $pdf->SetY(94.0);$pdf->SetX(10.0);$pdf->SetFont('Arial','',10); $pdf->Cell(0,00,"Utilizar Preferentemente antes de:");
		  $pdf->SetY(94.0);$pdf->SetX(185.0);$pdf->SetFont('Arial','b',10); $pdf->Cell(0,00,"$f_vencimientofo");
...
//		  $pdf->SetY(93.0);$pdf->SetX(65.0);$pdf->SetFont('Arial','b',10); $pdf->Cell(0,00,"$nomope $apellope");
		  $pdf->SetY(107.0);$pdf->SetX(10.0);$pdf->SetFont('Arial','',10); $pdf->Cell(0,00,"Condición:");
		  $pdf->SetY(107.0);$pdf->SetX(65.0);$pdf->SetFont('Arial','b',10); $pdf->Cell(0,00,"$unidad_medida");
...
if($id_caract_producto == 25){
		  ...
		  $pdf->SetY(176.0);$pdf->SetX(160.0);$pdf->SetFont('Arial','',8); $pdf->Cell(0,00,"FOLIO: I$dato");
		  $pdf->SetY(190.0);$pdf->SetX(10.0);$pdf->SetFont('Arial','',7); $pdf->Cell(0,00,"Pais de Origen: CHILE");
		  $pdf->SetY(200.0);$pdf->SetX(10.0);$pdf->SetFont('Arial','',7); $pdf->Cell(0,00,"Registro SAG: 13-62    Resolución SEREMI: 9242/04");
