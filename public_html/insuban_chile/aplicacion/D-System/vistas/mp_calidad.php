...
<!--								<li> <a href="#"><i class="fa fa-cog"></i> Settings</a> </li> 
		...
		<div id="page-wrapper">
			<div class="main-page">
			  <div class="tables">
				<h3 class="title1">Calidad Materia Prima</h3>
    			<div><a href="../controladores/informes_excel/excel_encargados.php">Informe_Excel</a></div>
...
<?
	...
	echo "<h4>Rendimiento Materia Prima:</h4>";
	echo "<table class='table table-bordered'>";
	echo "<thead>";
	echo "<tr>
      <th>FECHA</th><th>OPERARIA</th><th>ORIGEN</th><th>GRUPO</th><th>N_BIDON</th><th>NUDOS_E</th><th>NUDOS_R</th><th>SUBTOTAL_NUDOS</th></tr> \n";
	echo "</thead>";
...
$sum6 = $varx1+$varx2+$varx3+$varx4+$varx5+$varx6;
  	...
  	echo "<tr>
    <td>$row5[1]</td><td>$row5[2]</td><td>$row5[3]</td><td>$row5[4]</td><td>$row5[5]</td><td>$row5[6]</td><td align='center'>$row5[7]</td><td align='center'>$subtot_nudos</td>
   </tr> \n";
}
	echo "</tbody>";
	echo "</table>";
