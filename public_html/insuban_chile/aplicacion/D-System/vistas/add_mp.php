		...
		<div id="page-wrapper">
			<div class="main-page signup-page">
				<div class="sign-up-row widget-shadow">
					<h5>Informacion Materia Prima :</h5>
				<form method="post" action="../modelos/insert_org.php">	
					...
					<div class="sign-u">
						...
						<div class="sign-up2">
							<input type="text" name="codigo" id="codigo" style="width: 300px; height: 24px;" required>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="sign-u">
						...
						<div class="sign-up2">
							<input type="text" name="nombre" id="nombre" style="width: 100px; height: 24px;" required>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="sub_home">
