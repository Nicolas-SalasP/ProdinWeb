...
<!--								<li> <a href="#"><i class="fa fa-cog"></i> Settings</a> </li> 
		...
		<div id="page-wrapper">
			<div class="main-page">
				<h3 class="title1">Produccion Faena</h3>
				<div class="blank-page widget-shadow scroll" id="style-2 div1">
					...
					<div class="form-group">
					  ...
					  <input type="text" class="form-control" id="faena">
					</div>
					<div class="form-group">
					  <label for="decomiso">DECOMISO:</label>
					  <input type="text" class="form-control" id="decomiso">
					</div>
					<div class="checkbox">
					  <label><input type="checkbox" value="1">Faena Tercero</label>
					</div>
				</div>
			</div>
		</div>
