...
if ($busca) {
  ...
  $fecha = date("Y-m-d");
	...
	$sql1=mysql_query("SELECT rem.id, rem.fecha, pro.producto, org.origen, rem.n_bidon, rem.n_mallas, rem.f_faena, grp.grupo, rem.f_salida_produccion FROM remojo As rem, origenes As org, producto As pro, grupo as grp where org.id_origen = rem.procedencia and grp.idgrupo = rem.idGrupo2 and pro.id_producto = rem.producto and rem.f_salida_produccion = '$fecha' ORDER BY id DESC", $con);
...
<!--								<li> <a href="#"><i class="fa fa-cog"></i> Settings</a> </li> 
		...
		<div id="page-wrapper">
			<div class="main-page">
			  <div class="tables">
				<h3 class="title1">Registro Materia Prima</h3>
    			  <div> <a href="../controladores/informes_excel/excel_remojo.php">Informe_Excel</a> </div>
...
<?
	...
	echo "<h4>Materia Prima Utilizada:</h4>";
	...
	echo "<table border ='0' width='100%'>";
   	echo "<tr>
    <td width='100' nowrap='nowrap'>&nbsp;</td><td width='10' nowrap='nowrap' align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>TOTAL UNIDADES:</strong>&nbsp;&nbsp;<b>$sum1</b></td>
         	</tr>";
   	echo "</table>";
