...
$query2=mysql_query("SELECT gp.grupo,op.onombre,pe.n_bandeja,pe.cantidad
		...
		<div id="page-wrapper">
			<div class="main-page">
				...
				<h3 class="title1">Trabajadores</h3>
					<div> <a href="../controladores/informes_excel/excel_plasticos.php">Informe_Excel</a></div>
...
<?
	...
	echo "<h4>Plasticos:</h4>";
	echo "<table class='table table-bordered'>";
	echo "<thead>";
	echo "<tr>
      <th>GRUPO</th><th>NOMBRE</th><th>BANDEJAS</th><th>PLASTICOS</th></tr> \n";
	echo "</thead>";
	...
	$varx22+=$plas;
   	...
   	echo "<tr>
    <td>$row2[0]</td><td>$row2[1]</td><td>$band</td><td>$plas</td>
   </tr> \n";
}
	echo "<tr> <td>TOTALES:</td><td> </td><td>$varx21</td><td>$varx22</td> </tr> \n";
	echo "</tbody>";
	echo "</table>";
	echo "</div>";
?>		</div>
