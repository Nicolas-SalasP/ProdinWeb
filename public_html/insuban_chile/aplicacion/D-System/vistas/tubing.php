...
if ($busca) {
  ...
  $fecha = date("Y-m-d");
	...
	$sql1=mysql_query("SELECT sal.idCodigo,enc.nombre,sal.fechaSalado,pro.n_bandeja,ope.onombre,ope.iniciales,cal.calibre,pro.cantidad 
					FROM salado as sal
					...
					where sal.fechaSalado='$fecha' group by sal.idSalado order by sal.idSalado desc", $con);
...
<!--								<li> <a href="#"><i class="fa fa-cog"></i> Settings</a> </li> 
		...
		<div id="page-wrapper">
			<div class="main-page">
			  <div class="tables">
				<h3 class="title1">Registro Tubing</h3>
					<div> <a href="../controladores/informes_excel/excel_tubing.php">Informe_Excel</a></div>
...
<?
	...
	echo "<tbody class='contenidobusqueda'>";
	 ...
	 while ($row2=mysql_fetch_row($sql1)) {
