...
<body class="cbp-spmenu-push">
            ...
            <ul class="nav nav-second-level collapse">
		      <li>
		        <a href="#">Trabajador<span class="fa arrow"></a>
		          <ul class="nav nav-second-level collapse">
                  <li>
                    <a href="list.php" class="active">&nbsp; Listar</a>
                  </li>
                  <li>
   ...
   <script language="JavaScript" type="text/javascript">
    function show5(){
		...
		<div id="page-wrapper">
			<div class="main-page">
				<h3 class="title1">Origenes</h3>
				<div class="blank-page widget-shadow scroll" id="style-2 div1">
					<?
	echo "<a href='add_mp.php'><img src='images/button_agregar-nuevo.png' width='15%' align='right' /></a>";
	echo "<div><table border='1' width='100%'><tr><th style='width: 35px; height: 28px;'>ID</th><th style='width: 165px; height: 28px;'>NOMBRE</th></tr></table></div>";
	...
	echo"<tr>";
		...
		mysql_select_db("$database", $con);
				...
				$query=mysql_query("SELECT * FROM origenes order by id_origen desc");
				while ($row=mysql_fetch_array($query)) {
							
					$id_org=$row[id_origen];
					$origen=$row[origen];

//				echo "<form action='../modelos/upd_org.php' method='get'>";
				echo "<input type='text' value='$id_org'  disabled>";
//				echo "<input type='hidden' name='id_org' value='$id_org'>";				
				echo "<input type='text' name='origen' value='$origen'  disabled><br/>";
//				echo "<input type='submit' name='btnUpdate' value='Actualizar'/>";
//				echo "<input type='button' onclick='preguntar($id_org)' value='Eliminar'/>";
//				echo "</form>";     
				}
	echo "</tr>";					
	echo "</table>";
