...
function preguntar(id){
   ...
   //Redireccionamos si das a aceptar
     window.location.href = "../negocio/delete_17.php?id=" + id; //página web a la que te redirecciona si confirmas la eliminación
//else
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="func.search_3_15.php">Proceso 3</a></li>
    </ul>
...
<form action='../negocio/insert_2_15.php' method="POST">		
...
*/
		...
		$results5 = mysql_query("SELECT * FROM proceso_encargado2 where idgrupo1 = 14 order by idproceso_encargado2 DESC limit 1 ");
		while ($arr5 = mysql_fetch_array($results5)) {?>
		
		<td><input type="text" name="bidon" value="<? echo $arr5[5]; ?>" style="width: 200px; height: 24px" ></td>
	...
	<tr>
		...
		<td><select name="operaria" size="1" style="width: 200px; height: 24px; " required>	
			...
			$results3 = mysql_query("SELECT * FROM operarias where idgrupo = 14 and activo=1 order by onombre asc");
			...
			echo "<option value='0'>".Seleccione."</option>\n";
			 ...
			 <td><SELECT name="grupo" size="1" style="width: 100px; height: 24px" required> 
			      ...
			      <OPTION value="14">VERD/BLANC</OPTION>  
    	...
    	<div class="jumbotron">
      	...
      	<?
			...
			$query5 = mysql_query("SELECT pr2.idproceso_encargado2, pr2.fecha, ope.onombre,org.origen,grp.grupo,n_bidon,n_nudos_e, n_nudos_r,org.id_origen 
				...
				where pr2.f_registro='$hoy' and pr2.idgrupo1=14 order by pr2.idproceso_encargado2 DESC", $con);
