...
function preguntar(id){
   ...
   //Redireccionamos si das a aceptar
     window.location.href = "../negocio/delete_17_3.php?id=" + id; //página web a la que te redirecciona si confirmas la eliminación
//else
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li><a href="func.search_4_15.php">Proceso 2</a></li>
...
<div class="container">
   ...
   <!-- Main component for a primary marketing message or call to action -->
      ...
      <div class="jumbotron">
       ...
       <form action="../negocio/insert_3_15.php" method="post">		
...
<!-- code 1 -->
       ...
       <div class="jumbotron">
      	...
      	<?
					...
					where sal.fechaSalado='$f_actual' and pro.idEncargado=15 group by sal.idSalado order by sal.idSalado desc");
