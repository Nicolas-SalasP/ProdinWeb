		  ...
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li class="current"><a href="#"><i class="glyphicon glyphicon-stats"></i> Generar Código Barra</a></li>
		  	...
		  	<div class="row">
		  		<div class="col-md-12 panel-primary">
		  			...
		  			<div class="content-box-header panel-heading">
	  					<div class="panel-title ">Código de <b>Barras</b></div>
		  			</div>
...
<!-- Code... bloque2 
<form action="ejemplo2.php" method="post" target="popup"
	onsubmit="window.open('', 'popup', 'width = 800, height = 600, top=0, left=0, scrollbars=yes')">
CODIGO CORTOS:
    <input name="codigo" type="text" value="<? echo $str[0],$str[2],$str[3],$cant ?>" style="background-color:#CCF"/>
    <input type="hidden" name="operaria" value="<? echo $O ?>">
    <input type="hidden" name="calibre" value="<? echo $C ?>">
    <input type="submit" value="Generar"  />
</form>
