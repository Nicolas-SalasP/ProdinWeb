...
function preguntar(id){
   ...
   //Redireccionamos si das a aceptar
     window.location.href = "../negocio/delete_16.php?id=" + id; //página web a la que te redirecciona si confirmas la eliminación
//else
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="func.search_3_16.php">Proceso 3</a></li>
    </ul>
...
<form action='../negocio/insert_2_16.php' method="POST">		
...
*/
		...
		$results5 = mysql_query("SELECT * FROM proceso_encargado2 where idgrupo1 = 12 order by idproceso_encargado2 DESC limit 1 ");
		while ($arr5 = mysql_fetch_array($results5)) {?>
	...
	<tr>
		...
		<td><select name="operaria" size="1" style="width: 200px; height: 24px; " required>	
			...
			$results3 = mysql_query("SELECT * FROM operarias where idgrupo = 12 and activo=1 order by onombre asc");
    	...
    	<div class="jumbotron">
      	...
      	<?
			...
			$query5 = mysql_query("SELECT pr2.idproceso_encargado2, pr2.fecha, ope.onombre,org.origen,grp.grupo,n_bidon,n_nudos_e, n_nudos_r,org.id_origen
				...
				where pr2.f_registro='$hoy' and pr2.idgrupo1=12 order by pr2.idproceso_encargado2 DESC", $con);
