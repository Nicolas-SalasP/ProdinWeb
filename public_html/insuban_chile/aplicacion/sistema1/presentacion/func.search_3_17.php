...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li><a href="func.search_5.php">Cierres Diarios</a></li>
      <li class="active"><a href="#">Ingreso Plasticos</a></li>
    </ul>
...
<div class="container">
      ...
      <nav class="navbar navbar-default">
        ...
        <div class="container-fluid">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" >Ingreso <b>Registros</b></a>
   ...
   <!-- Main component for a primary marketing message or call to action -->
      <div class="jumbotron">
       <form action="../negocio/insert_3_17.php" method="post">		
		<table class="table">
