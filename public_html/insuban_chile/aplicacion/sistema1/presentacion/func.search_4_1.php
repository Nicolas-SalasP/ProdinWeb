...
function preguntar(id){
   ...
   //Redireccionamos si das a aceptar
     window.location.href = "../negocio/delete_1.php?id=" + id; //página web a la que te redirecciona si confirmas la eliminación
//else
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="func.search_100.php">AGROSUPER</a></li>      
    </ul>
...
<form action='../negocio/insert_2_1.php' method="POST">		
...
<!--		<td><input type="text" name="origen" value="<? echo $arr5[3]; ?>" style="width: 200px; height: 24px" required></td> -->
		...
		$results5 = mysql_query("SELECT * FROM proceso_encargado2 order by idproceso_encargado2 DESC limit 1 ");
		while ($arr5 = mysql_fetch_array($results5)) {?>
...
<br><br><br>
    	...
    	<div class="jumbotron">
      	...
      	<?
			...
			$query5 = mysql_query("SELECT pr2.idproceso_encargado2, pr2.fecha, ope.onombre,org.origen,grp.grupo,n_bidon,n_nudos_e, n_nudos_r 
				FROM proceso_encargado2 as pr2
				...
				where pr2.f_registro='$hoy' order by pr2.idproceso_encargado2 DESC", $con);
...
$x2 = $row5[7];
$subtot_nudos = $x1 - $x2;
//print_r($subtot_nudos);
$sum5+=$subtot_nudos;

//$sum6+=$subtot_nudos * 20;
