...
if ($radio == 1 and $id_origen == 5 ){ //com
		  $pdf->SetY(215.0);$pdf->SetX(84.0);$pdf->SetFont('Arial','',8); $pdf->Cell(0,00,"PLANTA DE ORIGEN: SAG 06-01");}
if ($radio == 1 and $id_origen == 28 ){//coe
		  $pdf->SetY(215.0);$pdf->SetX(84.0);$pdf->SetFont('Arial','',8); $pdf->Cell(0,00,"PLANTA DE ORIGEN: SAG 07-03");}
if ($radio == 1 and $id_origen == 29 ){//max
		  $pdf->SetY(215.0);$pdf->SetX(84.0);$pdf->SetFont('Arial','',8); $pdf->Cell(0,00,"PLANTA DE ORIGEN: SAG 06-17");}
if ($radio2 == 11){	 
...
//		  $pdf->Code128(88,245,"$code_a0$barral1$feceti$cod_a$code_a3",130,30);//barras_insuban
