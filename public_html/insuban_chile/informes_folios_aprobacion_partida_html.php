		...
		//echo " SUM $sum - Total $total";	
          ...
          <td valign="top" class="texto_informe1">
            <div align="left">
              <? 
/*		  
		$sql_fec_ven="SELECT p.id_paking_relacion, ef.id_etiquetados_folios, esp.id_especie, esp.especie, ef.f_vencimiento,  DATE_FORMAT( ef.f_vencimiento, '%M %Y' ) AS dateGroup, ef.id_destinos
        FROM paking AS p, etiquetados_folios AS ef, especie AS esp 
        WHERE 
        p.id_paking_relacion = $id_paking_relacion
        AND p.id_etiquetados_folios = ef.id_etiquetados_folios
    ...
    <tr>
      <td colspan="2"><table width="650" border="1" align="center">
		...
		?>
		  ...
		  <div align="left">
		<?
		$sql_fec_resm="SELECT p.id_paking_relacion, ef.id_etiquetados_folios, esp.id_especie, esp.especie, ef.f_elaboracion ,ef.f_termino,  DATE_FORMAT( ef.f_termino, '%M %Y' ) AS dateGroup
        FROM paking AS p, etiquetados_folios AS ef, especie AS esp 
        WHERE 
        p.id_paking_relacion = $id_paking_relacion
        AND p.id_etiquetados_folios = ef.id_etiquetados_folios
		...
		$sql_fec_empaque="SELECT p.id_paking_relacion, ef.id_etiquetados_folios, esp.id_especie, esp.especie, ef.f_termino,  DATE_FORMAT( ef.f_termino, '%M %Y' ) AS dateGroup
        FROM paking AS p, etiquetados_folios AS ef, especie AS esp 
        WHERE 
        p.id_paking_relacion = $id_paking_relacion
        AND p.id_etiquetados_folios = ef.id_etiquetados_folios
    ...
    <tr>
      <td colspan="2"><div align="center"><span class="texto_informe1">ORIGEN DE LA MATERIA PRIMA: &quot;ADJUNTO EN TRAZABILIDAD DEL PRODUCTO&quot;<br />
        Los productos y lotes cumplen con los requisitos sanitario del pa&iacute;s de destino<br />
              ...
              <? echo $pais;
		?>
            </span> y con los PPC del HACCP del establecimiento. En el procesamiento de las tripas naturales no se incorporan antibi&oacute;ticos </span></div><br></td>
    </tr>
    <tr>
