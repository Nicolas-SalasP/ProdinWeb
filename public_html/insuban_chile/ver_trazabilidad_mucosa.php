...
if($modificar_x){
$sql_modificar="UPDATE  etiquetados_folios set factura_trazab ='$factura_trazab', guia_despacho_trazab = '$guia_despacho_trazab' where id_etiquetados_folios=$id_etiquetados_folios";
$rest=mysql_query($sql_modificar);
...
?>
  <table width="563" border="0" align="center">
    <tr>
      ...
      <td width="435"><input name="factura_trazab" type="text" class="cajas" id="factura_trazab" value="<? echo $row[factura_trazab]?>" size="60" maxlength="60" /></td>
    </tr>
    <tr>
      <td class="titulo">N&ordm; Guia Despacho</td>
      <td width="435"><input name="guia_despacho_trazab" type="text" class="cajas" id="guia_despacho_trazab" value="<? echo $row[guia_despacho_trazab]?>" size="60" maxlength="60" /></td>
    </tr>
    <tr>
