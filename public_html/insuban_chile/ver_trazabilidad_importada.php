...
if($modificar_x){
$sql_modificar="UPDATE  etiquetados_folios set factura_importada ='$factura_importada' where id_etiquetados_folios=$id_etiquetados_folios";
$rest=mysql_query($sql_modificar);
...
?>
  <table width="563" border="0" align="center">
    <tr>
      ...
      <td width="435"><input name="factura_importada" type="text" class="cajas" id="factura_importada" value="<? echo $row[factura_importada]?>" size="60" maxlength="60" /></td>
    </tr>
    <tr>
