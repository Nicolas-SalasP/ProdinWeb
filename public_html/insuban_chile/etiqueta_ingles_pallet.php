...
if($id_etiqueta_idioma == 2 and $id_destinosotro == 3){
...
<table width="393" height="346" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="105" height="19" class="style7"><? if($id_destinos != 150){?>Consignor<? }else{?>Fabricado por<? } ?></td>
    <td width="5">:</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2"><span class="cajas">Antillanca Norte 391 (Chile) </span></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td height="20" class="style7">Export Country </td>
    <td class="style7">:</td>
    <td colspan="2" class="style7">Santiago Chile </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td height="20" class="style7">Destination Country </td>
    <td class="style7">:</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td height="19" class="style7">Consignee</td>
    <td class="style7">:</td>
    <td colspan="2" class="style7"><? echo $destinos?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td height="19" class="style7">Address</td>
    <td class="style7">:</td>
    <td colspan="2" class="style7"><? echo $domicilio;?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td height="19" class="style7">N&ordm; of Package </td>
    <td class="style7">:</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td height="21" class="style7">Transport </td>
    <td class="style7">:</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td height="21" class="style7">Quantity</td>
    <td class="style7">:</td>
    <td class="style7"><?
  ...
  <tr>
    <td>&nbsp;</td>
    <td height="19" class="style7">Tipe</td>
    <td class="style7">:</td>
    <td colspan="2"><span class="titulo">
      <?
	      echo "UNIDAD CIEGO DE VACUNO ";	
		  ?>
    </span></td>
  </tr>


<!-- moficacion de codigo nombre de producto  -->
...
-->
  ...
  <tr>
    <td>&nbsp;</td>
    <td height="19" class="style7">Production date </td>
    <td class="style7">:</td>
    <td class="style7"><? 
  ...
  <tr>
    <td>&nbsp;</td>
    <td height="19" class="style7">Experiration date </td>
    <td class="style7">:</td>
    <td class="style7"><? 
  ...
  <tr>
    ...
    <!-- <td height="50" colspan="4" valign="top" class="cajas">Mantener en Lugar Fresco y Seco a 15&ordm; C<br> 
      Monograf&iacute;a Reg. MGAP/DGSG/DIA ZZ 158/01<br />
    R&oacute;tulo Reg. MGAP/DGSG/DIA ZZ 158/02<br></td> -->
    <td height="50" colspan="4" valign="top" class="cajas"><br>Keep In Fresh and Dry Place at Temperature Not  
    More Than 25&ordm;C<br />
    <br></td> 
  </tr>
</table>
