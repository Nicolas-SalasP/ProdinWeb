...
}elseif ($id_destino ==358 or $id_destino ==446) {
  $destinos = "HENIL S.A.";
}?>
...
<tr>
    <td>&nbsp;</td>
    <td height="21" class="style7">Matadero </td>
    <td class="style7">:</td>
    <td class="style7"><?echo "Comafri"?></td>
  </tr>
-->
  <tr>
    <td>&nbsp;</td>
...
if ($id_destino ==176 or $id_destino ==276 or $id_destino ==372 or $id_destino==453 or $id_destino==186 or $id_destino==189 or $id_destino==446) {
...
<?
if ($id_destino ==453 or $id_destino ==6 or $id_destino ==199) {
...
?>
  ...
  <tr>
    ...
    <td height="50" colspan="4" valign="top" class="cajas">Mantener en Lugar Fresco y Seco a Temperatura Ambiente <?if ($id_destinos ==358 or $id_destinos ==396 or $id_destinos ==446) {?> <br> Reg. Monografia MGAP/DGSG/DIA/M 1795<br> Reg. Rotulo MGAP/DGSG/DIA/R 1795 <?}?><?if ($id_destinos == 104 or $id_destinos == 3 or $id_destinos ==176 or $id_destinos==372 or $id_destinos==453 or $id_destinos==189) {?><br>Ingredientes: Tripa de cerdo, agua, sal.<?}?> </td> 
<!--          
