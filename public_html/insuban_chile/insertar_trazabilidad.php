...
$id_etiquetados_folios_siguiente=$anook.$id_etiquetados_folios_siguiente;
  ...
  $recp=split(" ",$f_recepcion);  
  $rec=split("-",$recp[0]);  
  $f_recepcion1="$rec[2]-$rec[1]-$rec[0]";        
  $f_recepcionmes="$rec[1]";
  ...
  //$dat5=split(" ",$fecha_ven);  $dat7=split("-",$dat5[0]);  $f_vencimiento1="$dat7[0]-$dat7[2]-$dat7[1]";
...
$f_termino1  = date("Y-m-d");
$sql_nuevo="insert into etiquetados_folios  (id_etiquetados_folios,id_usuario,id_producto,ano,pallet,id_calibre,id_cruce_tablas,id_especie,id_unidad_medida,id_caract_producto,id_caract_envases,id_medidas_productos,id_envases,f_recepcion,f_elaboracion,f_inicio,f_termino,f_vencimiento,id_operarios,contenido_unidades,id_estado_folio,marca,id_procedencia,fech_generada_inicio) values ($id_etiquetados_folios_siguiente,$id_insuban,$id_producto_antes,'$fhoy','$palletes',$id_calibre,$codigonuevo,$id_especie,$id_unidad_medida,$id_caract_producto,$id_caract_envases,$id_medidas_productos,$id_envases,'$f_recepcion1','$f_elaboracion1','$f_inicio1','$f_termino1','$f_vencimiento1',$id_operarios,'$contenido_unidades',1,1,'N','$fech_generada_inicio')";
...
//echo "id_etiquetados_folios_siguiente $id_etiquetados_folios_siguiente<br>";
 ...
 $dat66=split("-",$key66); 
   if ($dat66[0] == 'id_pt')
   {
	...
	while ($row66=mysql_fetch_array($result4)) { 
		  ...
		  $sql_mod66="insert folios_mat (id_etiquetados_folios,id_mat,id_procedencia,contenido) values ($id_etiquetados_folios_siguiente,$id_ptw,'N',$contenido66)";
    ...
    <tr>
      <td colspan="4"><? if($buscar_faja or $id_producto and $desde){
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0">
            <tr>
              <td width="3%" nowrap bgcolor="#CCCCCC" class="titulo"><input type="checkbox" name="fresco" id="fresco" onClick="formcheck3(this,'1')"/></td>
              <td width="2%" bgcolor="#CCCCCC" class="titulo">N&deg;</td>
              <td width="7%" bgcolor="#CCCCCC" class="titulo">&nbsp;Folio</td>
            ...
            <tr>
              ...
              <td class="cajas"><? echo $i_nac?></td>
              <td class="cajas">F<?echo $r[id_mat_prima_nacional];?></td>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td nowrap bgcolor="#CCCCCC" class="titulo"><input type="checkbox" name="salado" id="salado" onClick="formcheck3(this,'2')"/></td>
              <td bgcolor="#CCCCCC" class="titulo">N&deg;</td>
              <td bgcolor="#CCCCCC" class="titulo">&nbsp;Folio</td>
              <td bgcolor="#CCCCCC" class="titulo">&nbsp;F. Salida </td>
              ...
              <td bgcolor="#CCCCCC" class="titulo">Costo MPN</td>
            ...
            <tr>
              ...
              <td width="2%" class="cajas"><? echo $i_imp?></td>
              <td width="9%" class="cajas">S<?
...
?>
  ...
  ?>
        <tr class="cajas">
		 ...
		 $id_etiquetados_foliospt1="3$id_etiquetados_foliospt";
          ...
          <td nowrap="nowrap">PT<? echo $id_etiquetados_foliospt?></td>
  ...
  <? } //  while ($r=mysql_fetch_array($result_buscar)) 
		...
		?>
  <? }?>
  <? if($cuantos_buscar or $cuantos_buscarimportada or $cuantospt){?>
