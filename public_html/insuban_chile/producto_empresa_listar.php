...
$sql="SELECT * FROM  producto AS pro, especie AS es WHERE pro.id_producto = pro.id_producto  and pro.id_estado != 2 and pro.id_producto != 0 and pro.id_especie = es.id_especie order by es.id_especie ASC";
...
<table width="600" height="65" border="0" align="center">
  <tr>
    <td height="14" valign="top"><span class="titulo">Listado  Materia Prima </span></td>
    </tr>
    <tr>
...
<?
	...
	?>
      <tr>
        ...
        <td class="cajas">&nbsp;<a href="?modulo=producto_empresa.php&id_p=<?echo $row[id_producto]?>&id_esp=<? echo $row[id_especie]?>"><? echo "$row[producto]";?></a></td>
