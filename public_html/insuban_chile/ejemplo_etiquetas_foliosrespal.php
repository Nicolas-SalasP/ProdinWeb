...
if($id_etf2){
$sql="SELECT * FROM etiquetados_folios where id_etiquetados_folios ='$id_etf2'";
...
//echo "modificar";
  ...
  $f_termino="$dat6[2]-$dat6[1]-$dat6[0]";
     ...
     $dat1ven=split(" ",$f_termino);
					   ...
					   $fecd=$datven[0]+1;
  					   $fecha_ven="$datven[1]";
				       $f_vencimiento="$fecd-$fecha_ven-$fech";
                  ...
                  <tr>
                    ...
                    <td colspan="4" align="left">
                      <? 
		 					...
		 					$procedencia= crea_procedencia($link,$row[id_procedencia],1);
                    ...
                    <? if($permiso34 == 1 and $nivel_usua == 1){?>
                   Total Ponderado: $ <? echo $row[total_ponderado] ?>
                    <? } ?>
                    </td>
                    </tr>
				  <? }?>
		...
		<table width="600" border="1" align="center" bordercolor="#CCCCCC">
          <tr>
            <td height="543" valign="top"><table width="587" border="0" align="center">
              ...
              <tr>
                <td width="145" class="titulo Estilo1">&nbsp;</td>
                <td width="432"><span class="numero">A&Ntilde;O <?php echo substr($fhoy,2,4); ?> FOLIO <?echo $row[id_etiquetados_folios]?></span></td>
              </tr>
              <tr>
                <td class="titulo">Codigo Interno </td>
				
				
                <td width="432"><input name="codigonuevo" type="text" class="cajas" id="codigonuevo" value="<?echo $codigonuevo?>" />
              ...
              <tr>
                ...
                <td width="432"><input name="codigobarra" type="text" class="cajas" id="codigobarra" value="<?echo $codigobarra?>" />
		 ...
		 $id_tipo_calculo2=$rowb[id_tipo_calculo];
		  ?></td>
              ...
              <tr>
                ...
                <td width="432"><? //$producto= crea_producto_onChange($link,$id_producto);
		 //echo $producto;?>
                  <? 
		  if($id_especie){
