...
$sql_pp="insert into pedido_tabla (id_pedidos,id_cruce_tablas,cantidadb,fecha_ingreso_producto_pedido) values ('$id','$codigo','$cantidadb','$fecha_ingreso_producto_pedido')";
