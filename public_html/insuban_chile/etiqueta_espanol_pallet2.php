...
$ini++;
		...
		$id_etiquetados_folios = 16003562;
		$id_etiquetados_folios = $id_etiquetados_folios + $num;
...
<table width="393" height="346" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td height="19" class="style7">Fecha Venc </td>
    <td class="style7">:</td>
    <td class="style7"><? 
...
//$nummf2 = $cuantospp2 + $id_etiquetados_folios;
