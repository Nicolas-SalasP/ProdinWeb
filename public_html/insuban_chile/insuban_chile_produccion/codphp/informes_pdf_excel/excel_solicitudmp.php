...
header("Cache-Control: must-revalidate, post-check=0, pre-check=0");
header("content-disposition: attachment;filename=excel_solicitudmp.csv");
echo "FOLIO PT; FOLIO M3;CODIGO;PRODUCTO;CALIBRE;ORIGEN;CONTENIDO;FACTURA;N BIDON;F/INGRESO;F/FAENA;F/VENCIMIENTO;ESTADO\n";
 ...
 echo "$id_mat_prima_importada;$folio_m3_mpi;$cruce_tablas_id;$producto;$calibre;$origen;$contenido;$comprobante_num;$bidon_num;$fecha_ingreso;$fecha_faena;$fecha_vencimiento;$estado_material;\n";
	}
