...
if($asignar){
    ...
    {
	$id=$dat[1];
   	$idfolios=$_POST["idfolios-$id"];  
	$sql="update etiquetados_folios set id_estado_folio=$id_estado_folio_cambio, fbodega='$fbodega' where id_etiquetados_folios = $idfolios";
...
<tr>
  <td colspan="2"><table width="98%" border="0">
    <tr>
      <td height="8" colspan="13"><!--<table width="100%" border="0" align="center">
     <tr>
 ...
 //if($cuantos and $buscar){?>
    <tr>
      ...
      <td colspan="10" bgcolor="#CCCCCC"><strong>&nbsp;Cantidad <? echo $cuantos?></strong></td>
      <td colspan="2" bgcolor="#CCCCCC"><select name="id_estado_folio_cambio">
        <option value="0">Seleccionar</option>
        <option value="2">MP</option>
      </select></td>
    </tr>
    <tr>
      <td width="22" height="19" nowrap="nowrap" bgcolor="#FF9933">&nbsp;N&ordm;</td>
      <td width="37" nowrap="nowrap" bgcolor="#FF9933"><strong>&nbsp;FOLIO</strong></td>
      <td width="37" nowrap="nowrap" bgcolor="#FF9933"><strong>&nbsp;COD</strong></td>
      ...
      <td width="86" nowrap="nowrap" bgcolor="#FF9933"><strong>&nbsp;UNID/MED</strong></td>
      <td width="129" nowrap="nowrap" bgcolor="#FF9933"><strong>&nbsp;MEDIDAS</strong></td>
      <td width="111" nowrap="nowrap" bgcolor="#FF9933"><strong>&nbsp;CARAC/PRO</strong></td>
      <td width="86" nowrap="nowrap" bgcolor="#FF9933"><strong>&nbsp;CARAC/ENV</strong></td>
      <td width="74" nowrap="nowrap" bgcolor="#FF9933"><strong>&nbsp;CONTENIDO</strong></td>
      <td width="64" nowrap="nowrap" bgcolor="#FF9933"><strong>&nbsp;OPERADOR</strong></td>
      <td width="33" nowrap="nowrap" bgcolor="#FF9933"><strong>&nbsp;ESTADO</strong></td>
      <td width="33" nowrap="nowrap" bgcolor="#FF9933">&nbsp;</td>
    </tr>
    <?
  ...
  ?>
	...
	echo $nom?>
      ...
      <td nowrap="nowrap" bgcolor="<? echo $color?>">&nbsp;
        ...
        <? }?></td>
      <td nowrap="nowrap" bgcolor="<? echo $color?>"><input type="checkbox" name="idfolios-<? echo $id_etiquetados_folios?>" id="idfolios" value="<? echo $idfolios?>" /><input type="hidden" name="idfolios-<? echo $id_etiquetados_folios?>" id="idfolios" value="<? echo $id_etiquetados_folios?>" /><? echo $id_etiquetados_folios?></td>
    </tr>
    <? } ?>
    <tr>
      <td height="19" colspan="13" align="right" nowrap="nowrap"><? if($cuantos){?>
