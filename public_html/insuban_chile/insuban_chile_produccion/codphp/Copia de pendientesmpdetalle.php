...
<table width="98%" border="0">
 ...
 <tr>
  ...
  <tr>
    ...
    <td width="156" nowrap="nowrap" bgcolor="#FF9933"><strong>&nbsp;CONTENIDO</strong></td>
    <td width="104" nowrap="nowrap" bgcolor="#FF9933"><strong>&nbsp;F/INGRESO</strong></td>
    <td width="190" nowrap="nowrap" bgcolor="#FF9933"><strong>&nbsp;F/ENTREGA</strong></td>
    <td width="129" nowrap="nowrap" bgcolor="#FF9933"><strong>&nbsp;ENCARGADO</strong><strong>&nbsp;</strong><strong>&nbsp;</strong></td>
  </tr>
     <?
	$i=$op;
    $color = "#000000";$i = 0;
  ...
  <tr>
    ...
    <td nowrap="nowrap" bgcolor="#999999">&nbsp;
    <? if(!$infomenu){?>
...
$cuantostotales= $cuantosn  + $cuantosi;
  ...
  <tr>
    ...
    <td width="68" nowrap="nowrap" bgcolor="#FF9933"><strong>&nbsp;ESTADO</strong></td>
     <? if(!$infomenu){?>
    <td width="33" align="center" nowrap="nowrap" bgcolor="#FF9933"><input name="eliminar" type="submit" id="eliminar" value="X" /></td>
    <? } ?>
    <td width="33" align="center" nowrap="nowrap" bgcolor="#FF9933"><strong>&nbsp;DISPONIBLE</strong></td>
  </tr>
     <?
	if($cuantosn){
    $i=$op;
  ...
  <tr>
    ...
    <td nowrap="nowrap" bgcolor="#FFFFFF">&nbsp;</td>
    <td nowrap="nowrap" bgcolor="#FFFFFF">&nbsp;</td>
    <td colspan="3" align="right" bgcolor="#FFFFFF"><? if(!$infomenu){?>
      <input type="submit" name="actualizar" id="actualizar" value="Informar disponibilidad" />
      <? } ?></td>
    </tr>
      </table></td>
    </tr>
    <tr>
      ...
      <? if($infomenu){?> <input type="submit" name="rechazarmp" id="rechazarmp" value="Rechazar Solicitud" /> <? } ?><br><br>
      <? if($infomenu){?>
       <input name="fecha_asig_producc" type="text" id="fecha_asig_producc"  value="<?echo $fecha_asig_producc?>" size="10" maxlength="10" /><a href="javascript:show_Calendario('form1.fecha_asig_producc');">Asignar Fecha</a>&nbsp;&nbsp;&nbsp;
      <input type="submit" name="asignarproduccion" id="asignarproduccion" value="Asignar a Producción" /><? } ?>
...
/*      if($cuentasino == $cuantosn){
    ...
    <tr>
      <td colspan="8">Nota: Para completar la solicitud debe indicar la disponibilidad de la materia prima</td>
  </tr>
    <tr>
      <td colspan="8"><HR>
    ...
    <tr>
      <td colspan="8"><div id="error" style="display: none;"><center><textarea name="observacionessolic" id="observacionessolic" cols="80" rows="5"><? echo $observacionessolic?></textarea></center>&nbsp;&nbsp;&nbsp;<center><input type="submit" name="guardarcomentarios" id="guardarcomentarios" value="Guardar Observaciones" /></center></div><HR></td>
    </tr>
</table>
