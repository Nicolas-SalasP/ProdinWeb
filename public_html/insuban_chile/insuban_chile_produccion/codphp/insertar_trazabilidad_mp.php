...
if($fecha_inicio and $fecha_termino or $buscar){
...
<table width="98%" border="0">
 ...
 <tr>
  ...
  <tr>
    ...
    <td width="68" align="center" bgcolor="#FF9933">
     <a href="javascript:seleccionar_todo()"><img src="../images/todos.jpg" width="13" height="13" border="0"/></a>
     <a href="javascript:deseleccionar_todo()"><img src="../images/ninguno.jpg" width="13" height="13" border="0"/></a>
    </td>
  </tr>
     <?
	if($cuantosmpn){
  ...
  <tr>
    ...
    <td align="center" nowrap="nowrap" bgcolor="<? echo $color?>">&nbsp;<input type="checkbox" name="id_mat-<? echo $id_mat_prima_nacional?>" id="id_mat" value="<? echo $id_mat_prima_nacional?>" />
    </td>
    <? }
	}
	$sum+=$j;
  ...
  <tr>
    ...
    <td align="center" nowrap="nowrap" bgcolor="<? echo $color?>">&nbsp;<input type="checkbox" name="id_mat3-<? echo $id_mat_prima_importada3?>" id="id_mat3" value="<? echo $id_mat_prima_importada3?>" /></td>
    <? }
