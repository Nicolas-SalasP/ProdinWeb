...
$largo=strlen($id_mat_prima_importada);
    ...
    <? }?>
      ...
      <table width="100%" border="0">
        ...
        <tr>
          ...
          <td width="30" nowrap="nowrap" bgcolor="#FF9933"><strong>&nbsp;FOLIO M3</strong></td>          
          <td width="30" nowrap="nowrap" bgcolor="#FF9933"><strong>&nbsp;FOLIO ANT.</strong></td>
  ...
  ?>
        <tr>
          ...
          <a href="?modulo=ingresarpt.php&id_etiquetados_folios=<? echo $id_etiquetados_folios?>"><? echo $id_folio_m3?></a></td>          
          <td nowrap="nowrap" bgcolor="<? if($id_estdis == 1){ echo "#00CC33";}else{ echo "$color";}?>">&nbsp;PT<? echo $id_etiquetados_folios?></a></td>
