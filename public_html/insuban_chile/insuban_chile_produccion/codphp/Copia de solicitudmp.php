...
$sql.= "  and mpn.fecha_asig_producc = '0000-00-00' order by mpn.id_mat_prima_nacional asc";
...
$sqli.= "  and mpi.fecha_asig_producc = '0000-00-00' order by mpi.id_mat_prima_importada asc";
...
//if($asignar and $unidadessolicitadas){
	if($asignar){
	     ...
	     $dat=split("-",$dat1[0]);
 		 ...
 		 $fechasmp = date("Y-m-d");
		 $sql_smp="insert solicitud_mp(id_usuario,id_ldp,id_procedencia,id_origen,id_producto,id_calibre,unidadessolicitadas,fechaentreg ,fechasmp) values ('$id_insuban','$id_ldp','$id_procedencia','$id_origen','$id_producto','$id_calibre','$unidadessolicitadas','$fechaentregok','$fechasmp')";
...
<table width="98%" border="0">
 <tr>
   <td height="8" colspan="13">&nbsp;<? include "filtro_pt.php";?></td>
  </tr>
 <tr>
   <? if($cuantostotales){?>
  ...
  <tr>
    ...
    <td width="111" nowrap="nowrap" bgcolor="#FF9933"><strong>&nbsp;
        <? if($id_procedencia == "I"){ ?>
        FACTURA
        <? }?>
        <? if($id_procedencia == "N"){ ?>
