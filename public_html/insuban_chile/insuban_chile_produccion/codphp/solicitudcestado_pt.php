...
<table width="1010" height="326" border="0">
 ...
 <tr>
   <td height="9" colspan="13"><BR>Nota: El siguiente informe muestra los Producto Terminado en estado de Bodega y Reservados. <strong>Productos asociados a pedidos no se puede reprocesar.</strong></td>
 </tr>
 <? if($buscar){?>
 <tr>
...
$sql="SELECT * FROM etiquetados_folios AS ef, producto AS p, calibre AS c, medidas_productos AS mpro, unidad_medida AS um,  caract_producto AS carpro, caract_envases AS carenv, operarios AS o, origenes AS orig, estado_folio AS e where  ef.id_etiquetados_folios=ef.id_etiquetados_folios and ef.id_producto = p.id_producto and ef.id_calibre = c.id_calibre  and ef.id_medidas_productos = mpro.id_medidas_productos  and ef.id_unidad_medida = um.id_unidad_medida and ef.id_caract_producto = carpro.id_caract_producto and ef.id_caract_envases = carenv.id_caract_envases and id_cruce_tablas != 0 and ef.id_origen = orig.id_origen and ef.id_operarios=o.id_operarios and ef.id_estado_folio = e.id_estado_folio and (ef.id_estado_folio = 2 or ef.id_estado_folio = 10) and ef.ocupado = 0 ";
...
$cuantos=mysql_num_rows($result);
  ...
  <tr>
    ...
    <td nowrap="nowrap" bgcolor="<? echo $color?>">&nbsp;<a href="?modulo=ingresarpt.php&id_etiquetados_folios=<? echo $id_etiquetados_folios?>&pt=<? echo "N";?>"><? echo $folio_m3?></a></td>
