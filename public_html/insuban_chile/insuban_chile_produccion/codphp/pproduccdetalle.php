...
<tr>
        ...
        <tr>
          <td><table width="1010" border="0" align="center">
            ...
            <tr>
              ...
              <td width="25" nowrap="nowrap" bgcolor="#FF9933"><strong>&nbsp;FOLIO</strong></td>
  ...
  ?>
            <tr>
              ...
              <td nowrap="nowrap" bgcolor="<? echo $color?>">&nbsp;<? echo $rown[origen]?><? echo $rown[id_origen]?></td>
              ...
              <td align="center" nowrap="nowrap" bgcolor="<? echo $color?>">&nbsp;<? echo $rown[estado_material]?> - <? echo $rown[fecha_salida]?></td>
...
//	 	echo $id_mat_prima_importada;
	 	echo $folio_m3_mpi;	 	
              ...
              <td align="center" nowrap="nowrap" bgcolor="<? echo $color?>">&nbsp;<? echo $rowi[estado_material]?> - <? echo $rowi[fecha_salida]?></td>
	...
	?>
            <tr>
              <td height="19" colspan="6" align="right" nowrap="nowrap" bgcolor="#FFFFFF">TOTAL</td>
