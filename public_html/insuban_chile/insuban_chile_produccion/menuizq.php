 ...
 $cuantosplanillaproduccion=mysql_num_rows($resultplanillaproduccion);
   ...
   //echo "stockpri $stockpri<br>";
		...
		$stockprok = $stockpr + $stockpri;
			   ...
			   <? if($id_ldp){?>
                <li><? if($tip == 1) {?><img src="codphp/jpgnew/flecha.jpg" width="16" height="13" /><? }?><a href="?modulo=solicitudmp.php&id_ldp=<? echo $id_ldp?>&tip=1">Crear solicitud de MP</a></li>
               <li><? if($tip == 2) {?><img src="codphp/jpgnew/flecha.jpg" width="16" height="13" /><? }?><a href="?modulo=pendientesmp.php&id_ldp=<? echo $id_ldp?>&tip=2">Solicitudes Pendientes MP  [<? echo $cuantossmp?>]</a> </li>
                ...
                <li><? if($tip == 4) {?> <img src="codphp/jpgnew/flecha.jpg" width="16" height="13" /><? }?><? if($cuantosrecepcion){?><a href="?modulo=recepcionmp.php&id_ldp=<? echo $id_ldp?>&infomenu=1&tip=4">Solicitudes Aceptadas [<? echo $cuantosrecepcion?>]</a><? }else{?>Solicitudes Aceptadas [<? echo $cuantosrecepcion?>]<? } ?></li>
                 <li><? if($tip == 5) {?> <img src="codphp/jpgnew/flecha.jpg" width="16" height="13" /><? }?><a href="?modulo=crea_planillaproduccion.php&id_ldp=<? echo $id_ldp?>&infomenu=1&tip=5">Crear Planilla de Producción </a></li>
                 <li><? if($tip == 6) {?> <img src="codphp/jpgnew/flecha.jpg" width="16" height="13" /><? }?><a href="?modulo=pproducc.php&id_ldp=<? echo $id_ldp?>&infomenu=1&tip=6">Listar Planillas Producción </a></li>
                <li><? if($tip == 7) {?> <img src="codphp/jpgnew/flecha.jpg" width="16" height="13" /><? }?><a href="?modulo=stockpr.php&id_ldp=<? echo $id_ldp?>&tip=7">Stock Producción</a></li>
   			  </ul>
              <? }
			  ?>
...
//$cuantoscpen=mysql_num_rows($resultcpen);
         ...
         <!--  <h1>MOVIMIENTO FOLIOS</h1>
             ...
             <h1>CAMBIO ESTADO</h1>
    		 <ul class="sidemenu">
    		 <li><? if($tic == 1) {?><img src="codphp/jpgnew/flecha.jpg" width="16" height="13" /><? }?><a href="?modulo=solicitudcestado.php&tic=1">Crear Solicitud Cambio Estado</a></li>
             <li><? if($tic == 2) {?><img src="codphp/jpgnew/flecha.jpg" width="16" height="13" /><? }?><a href="?modulo=solicitudcpendientes.php&tic=2">Cambios Est. Pendientes</a></li>
             
               <li><? if($tic == 3) {?><img src="codphp/jpgnew/flecha.jpg" width="16" height="13" /><? }?><a href="?modulo=solicitudcrechazadas.php&tic=3">Cambios Est. Rechazados</a></li>
             
             <li><? if($tic == 4) {?><img src="codphp/jpgnew/flecha.jpg" width="16" height="13" /><? }?><a href="?modulo=solicitudchistorial.php&tic=4">Listar Cambios de Estados</a></li>
             </ul>
             
             <h1>INVENTARIOS</h1>
    		 <ul class="sidemenu">
    		 <li><? if($tii == 1) {?><img src="codphp/jpgnew/flecha.jpg" width="16" height="13" /><? }?><a href="?modulo=inventarios/inventario_pt.php&tii=1">Producto Terminado</a></li>
             <li><? if($tii == 2) {?><img src="codphp/jpgnew/flecha.jpg" width="16" height="13" /><? }?><a href="?modulo=inventarios/inventario_fresco.php&tii=2">Producto Fresco</a></li>
             <li><? if($tii == 3) {?><img src="codphp/jpgnew/flecha.jpg" width="16" height="13" /><? }?><a href="?modulo=inventarios/inventario_salado.php&tii=3">Producto Salado</a></li>
             </ul>
             
             <h1>INFORMES DE PRODUCCION</h1>
    		 <ul class="sidemenu">
    		 <li><a href="#">Produccion por Planta</a></li>
             </ul>
             
             
 			 <h1>PTI -> MPI</h1>
    		 <ul class="sidemenu">
    		 <li><a href="?modulo=pt_a_mps.php">PTI -> MPI</a></li>
             </ul>
