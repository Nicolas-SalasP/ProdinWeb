...
*/
    ...
    */
    var festivos = [5,6];
    var festivosColor = "#FF9999";
    /**
    * definimos el tamao y familia de las fuentes
    */
    ...
    */
    ...
    /**
    * definimos los dias de cada mes para ao normal
    */
    Calendario.DiasMes = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
    /**
    * definimos los dias de cada mes para ao bisiesto
    */
   ...
   /** 
	* vemos si el ao es bisiesto o no, para asignar los dias correspondientes a febrero
	*/
    ...
    /**
    * funcion para incrementoementar o decrementar 1 mes o 1 ao al pulsar las dobles flechas
    ...
    */
    ...
    /**
    * aadimos propiedades al objeto Calendario mediante el metodo prototype
    */
    ...
    Calendario.prototype.show = function() 
    {
        ...
        */
		...
		"text=\"" + this.gTextColor + "\" leftmargin=\"10\" topmargin=\"0\" marginwidth=\"0\" marginheight=\"0\">");
	    ...
	    this.wwrite("<TABLE WIDTH='160' BORDER=0 CELLSPACING=0 CELLPADDING=0><TR><TD ALIGN=center>");
		...
		<!--"';window.opener.document.location.replace('?modulo=ejemplo_etiquetas_folios.php&nuevo2=1'); + window.close(); \">" +-->
    }
    ...
    */
    Calendario.prototype.cal_header = function() 
    {
    	...
    	vCode = vCode + "<TD WIDTH='14%'><FONT SIZE='2' FACE='" + familia_fuente + "' COLOR='" + this.gHeaderColor + "'><B>L</B></FONT></TD>";
    	vCode = vCode + "<TD WIDTH='14%'><FONT SIZE='2' FACE='" + familia_fuente + "' COLOR='" + this.gHeaderColor + "'><B>M</B></FONT></TD>";
    	vCode = vCode + "<TD WIDTH='14%'><FONT SIZE='2' FACE='" + familia_fuente + "' COLOR='" + this.gHeaderColor + "'><B>M</B></FONT></TD>";
    	vCode = vCode + "<TD WIDTH='14%'><FONT SIZE='2' FACE='" + familia_fuente + "' COLOR='" + this.gHeaderColor + "'><B>J</B></FONT></TD>";
    	vCode = vCode + "<TD WIDTH='14%'><FONT SIZE='2' FACE='" + familia_fuente + "' COLOR='" + this.gHeaderColor + "'><B>V</B></FONT></TD>";
    	vCode = vCode + "<TD WIDTH='16%'><FONT SIZE='2' FACE='" + familia_fuente + "' COLOR='" + this.gHeaderColor + "'><B>S</B></FONT></TD>";
        vCode = vCode + "<TD WIDTH='14%'><FONT SIZE='2' FACE='" + familia_fuente + "' COLOR='" + this.gHeaderColor + "'><B>D</B></FONT></TD>";
       vCode = vCode + "</TR>";	
    	return vCode;
    }
    ...
    function show_Calendario() 
    {
	    ...
	    */
        ...
        if (arguments[3] == null)
		    ...
		    formato = arguments[3];
	    /**
        * OJO: CONFIGURAR AQUI EL TAMA� DE LA VENTANA FLOTANTE
        */
        vWinCal = window.open("", "Calendario", "width=200,height=200,status=no,resizable=no,top=200,left=200");
	    vWinCal.opener = self;
	    calculo = vWinCal;
