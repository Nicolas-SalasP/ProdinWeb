...
if($ultimoanorescatado == $fhoy){
 ...
 $id_mat_prima_nacional_siguiente=$anook.$id_mat_prima_nacional_siguiente;
  ...
  if($observaciones=='')
   ...
   $sql_nuevo="insert into mat_prima_nacional (id_mat_prima_nacional,id_origen,ano,id_producto,id_estado_material,comprobante_num,bidon_num,contenido,rcp,temperatura1,temperatura2,observaciones,fecha_faena,fecha_termino,fecha_ingreso,id_unidad_medida,id_medidas_productos,id_calibre,valor_cmp,fech_generada_inicio) values ('$id_mat_prima_nacional_siguiente','$id_origen','$fhoy','$id_producto','1','$comprobante_num','$bidon_num','$contenido','$rcp','$temperatura1','$temperatura2','$observaciones','$fecha_faena1','$fecha_termino1','$fecha_ingreso1','$id_unidad_medida','$id_medidas_productos','$id_calibre','$valor_cmp','$fech_generada_inicio')";
      ...
      <table width="600" border="1" align="center" bordercolor="#CCCCCC">
        <tr>
          <td><table width="514" border="0" align="center">
            ...
            <tr>
              <td colspan="3" class="titulo"  ><table width="426" height="32" border="0" cellpadding="0" cellspacing="0">
                  <tr>
