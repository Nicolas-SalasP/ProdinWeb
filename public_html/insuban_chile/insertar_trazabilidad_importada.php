...
$resultul=mysql_query($sqlul);
 ...
 $dat1ven=split(" ",$f_termino);
   ...
   $sql_nuevo="insert into etiquetados_folios  (id_etiquetados_folios,id_producto,ano,id_calibre,id_cruce_tablas,id_especie,id_unidad_medida,id_caract_producto,id_caract_envases,id_medidas_productos,id_envases,id_origen,compro_nro,f_elaboracion,f_inicio,f_termino,f_vencimiento,id_operarios,contenido_unidades,id_estado_folio,factura_importada,id_procedencia,bidon_importado,fech_generada_inicio) values ($id_etiquetados_folios_siguiente,$id_producto2,'$fhoy',$id_calibre,$codigonuevo,$id_especie,$id_unidad_medida,$id_caract_producto,$id_caract_envases,$id_medidas_productos,$id_envases,$id_origen,'$compro_nro','$f_elaboracion1','$f_inicio1','$f_termino1','$f_vencimiento1',$id_operarios,'$contenido_unidades',1,$factura_importada,'I','$bidon_importado','$fech_generada_inicio')";
 //echo "--->$sql_nuevo<br>";
...
<form id="form1" name="form1" method="post" action="">
  <table width="563" border="0" align="center">
    <tr>
      <td width="118" class="titulo">Factura Importaci&oacute;n </td>
      <td width="435"><input name="factura_importada" type="text" class="cajas" id="factura_importada" value="<? echo $factura_importada?>" size="30" maxlength="30"></td>
    </tr>
  </table>
