...
// se agrega tabla producto en la Qry, solicitado por Lorena Anfruz
				...
				ef.folio_m3 as folio_m3 ,ef.id_etiquetados_folios AS id_etiquetados_folios, ef.id_producto, Prd.Producto FROM paking AS p, etiquetados_folios As ef, producto As Prd where p.id_paking_relacion=$id_paking_relacion and p.id_etiquetados_folios= ef.id_etiquetados_folios and ef.id_producto = Prd.id_producto order by ef.nombre_alt, ef.calibre_alt, ef.id_cruce_tablas, ef.id_etiquetados_folios asc";
