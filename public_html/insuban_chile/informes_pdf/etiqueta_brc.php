...
$pdf->ezImage("brc.png", 0, 60, 'none', 'left');
...
$pdf->ezText(utf8_decode("<b>Comprador: 	BRC TRIPAS COMERCIO DE TRIPAS LTDA</b>"),9);
$pdf->ezText(utf8_decode("			          Rua Domingos Jose Cabral, 43 - Sala 02 - 
													Bairro Fazenda CEP: 88.301-260, Itajaí/SC - 
													Brasil CNPJ: 25.166.185/0002-10"),10);
