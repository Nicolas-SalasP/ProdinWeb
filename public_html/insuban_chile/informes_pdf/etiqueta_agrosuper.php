...
$pdf->ezText(utf8_decode("PROCESADORA INSUBAN SPA"),16);

$pdf->addJpegFromFile('../jpg/NR1362.jpg', puntos_cm(2), puntos_cm(4));

$pdf->addText(puntos_cm(2.0),puntos_cm(3),16,'NUMERO DE LOTE  '.$factura);
