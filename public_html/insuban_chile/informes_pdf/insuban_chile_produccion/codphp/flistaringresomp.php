...
if($dato){ $sqli.= " and mpi.id_mat_prima_importada = '$dato' "; }
      ...
      <tr>
        ...
        <td width="955" nowrap="nowrap"><table width="1016" border="0">
		  ...
		  echo $procedencia;
            ...
            <input name="id_mat_prima_importada" type="text" id="id_mat_prima_importada" value="<? echo $id_mat_prima_importada?>" size="8" maxlength="8" />
...
<? } ?></td>
 ...
 <? if($cuantostotales){?>
  ...
  <tr>
    ...
    <a href="?modulo=flistaringresomodetalle.php&amp;factura_mp=<?echo $row[factura_mp]?>&amp;cuentabidones=<?echo $cuentabidones?>&amp;contenido=<?echo $contenido?>&fresca=<? echo "N";?>"><? echo $row[factura_mp]?></a>
...
<table>
   ...
   <tr>
      ...
      <td><div>
          ...
          <a href="codphp/informes_pdf_excel/excel_producto_fresco.php"><img src="../jpg/icono-excel.gif"></a> Informe 2015-2018 FRESCO
...
<table>
   ...
   <tr>
      ...
      <td><div>
          ...
          <a href="codphp/informes_pdf_excel/excel_producto_salado.php"><img src="../jpg/icono-excel.gif"></a> Informe 2017-2018 SALADO
