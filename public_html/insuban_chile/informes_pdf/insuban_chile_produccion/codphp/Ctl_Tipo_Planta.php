...
if($fecha_ingreso_in){
  ...
  if($observaciones=='')
   ...
   $sql_nuevo="insert into mat_prima_nacional (id_mat_prima_nacional,id_operarios,id_origen,ano,id_producto,id_estado_material,comprobante_num,bidon_num,factura_mp,contenido,rcp,temperatura1,observaciones,fecha_faena,fecha_termino,fecha_venci,fecha_ingreso,fecha_salida,id_unidad_medida,id_medidas_productos,id_calibre,fech_generada_inicio) values ('$id_mat_prima_nacional_siguiente','$id_operarios','$id_origen','$fhoy','$id_producto','$id_estado_materialotro','$comprobante_num','$bidon_num','$factura_mp','$contenido','$rcp','$temperatura1','$observaciones','$fecha_faena1qq','$fecha_termino1','$fecha_venci','$fecha_ingreso_in','$fecha_despacho_in','$id_unidad_medida','$id_medidas_productos','$id_calibre','$fech_generada_inicio')";
