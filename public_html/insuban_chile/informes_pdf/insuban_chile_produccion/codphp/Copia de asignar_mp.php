...
$sql.= "  and mpn.id_solicitud_mp = 0 order by mpn.id_mat_prima_nacional desc";
...
$sqli.= "  and mpi.id_solicitud_mp = 0 order by mpi.id_mat_prima_importada desc";
$resulti=mysql_query($sqli);
$cuantosi=mysql_num_rows($resulti);

//echo "SQL -> $sqli<br>";
//echo "<br>cccii $cuantosi<br>";
}//if($id_procedencia == "I" and $buscar){
}
...
<? if($tip == 3){ ?>
window.opener.document.location.replace('http://200.63.96.220/~insubac/<? echo $url;?>/sp/sistema.php?modulo=pendientesmpdetalle.php&id_solicitud_mp=<? echo $id_solicitud_mp?>&id_ldp=<? echo $id_ldp?>&infomenu=<? echo $infomenu?>&tip=<? echo $tip?>');
<? } ?>
<? //if($tip == 4){ ?>
<!--window.opener.document.location.replace('http://200.63.96.220/~insubac/<? //echo $url;?>/sp/sistema.php?modulo=pproduccdetalle.php&fecha_asig_producc=<? //echo $fecha_asig_producc?>&id_ldp=<? //echo $id_ldp?>&tip=<?// echo $tip?>');-->
<? //} ?>
</script>
...
<table width="98%" border="0">
 ...
 <tr>
  ...
  <tr>
    ...
    <? if($buscar and $id_producto and $unidadessolicitadas){?>
