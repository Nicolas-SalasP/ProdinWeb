...
AND ef.id_estado_folio = e.id_estado_folio
and ef.id_caract_producto not in (25,30)  and ef.id_procedencia = 'N' and hipt.f_toma_inventario  = '$f_toma_inventariof'";
...
header("content-disposition: attachment;filename=inventario_producto_terminado.csv");
...
AND ef.id_origen = orig.id_origen
AND ef.id_estado_folio = e.id_estado_folio
 and ef.id_caract_producto in (25,30) and ef.id_procedencia = 'N' and hipt.f_toma_inventario  = '$f_toma_inventariof' ";
 //AND e.id_estado_folio != 7 and e.id_estado_folio != 5 and e.id_estado_folio != 6 and e.id_estado_folio != 10 and e.id_estado_folio != 9 and e.id_estado_folio != 4
