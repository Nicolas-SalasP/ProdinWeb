<?
$sql="SELECT smp.id_solicitud_mp AS id_solicitud_mp,smp.fechasmp AS fechasmp, smp.fechaentreg AS fechaentreg, smp.fecharechazomp AS fecharechazomp, smp.unidadessolicitadas AS unidadessolicitadas, org.origen AS origen, p.producto AS producto, c.calibre AS calibre, u.username AS username  
...
<h1>SOLICITUD DE PRODUCCION RECHAZADAS</h1>
<table width="1010" border="0">
 ...
 <tr>
  ...
  <tr>
    <td width="20" height="8" nowrap="nowrap" bgcolor="#FF9933"><center><strong>N&deg; SOLICIT</strong></center></td>
    ...
    <td width="71" nowrap="nowrap" bgcolor="#FF9933"><strong>&nbsp;ORIGEN</strong></td>
  ...
  <tr>
    ...
    <td nowrap="nowrap" bgcolor="<? echo $color?>">&nbsp;<? echo $fecharechazomp?></td>
