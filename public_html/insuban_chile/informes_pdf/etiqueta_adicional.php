...
$pdf->ezImage("fri.png", 0, 60, 'none', 'left');
/*
...
$pdf->ezText('', 10);																
$pdf->ezText("<b>Bombona:</b> ",10);
$pdf->ezText(utf8_decode("<b>Quantidade:  MAÇOS</b>"),10);
$pdf->ezText("<b>Calibre: 32/36</b>  ",10);
$pdf->ezText('', 10);
$pdf->ezText(utf8_decode("<b>961 - 32/36 6 FIOS</b>"),10);
