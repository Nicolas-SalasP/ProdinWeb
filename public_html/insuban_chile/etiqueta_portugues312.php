...
<table width="393" height="421" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td height="20" colspan="2"><P>AIN GLOBAL Importação e Exportação Ltda  
                                CNPJ: 10.291.570/0001-31
                                Rua Dona Francisca, 8300 – Bloco 10 – Modulo C – Distrito Industrial
                                CEP: 89.219-600, Joinville/SC – Brasil</P></td>
  ...
  <tr>
    ...
    <td height="20" colspan="2"><? echo $domicilio?> CEP:88.317-100, Itajaí/SC - Brasil CNPJ: 25.331.971/0002-26</td>
  ...
  <tr>
    ...
    if($id_destinos != 130 and $id_destinos != 14 and $id_destinos != 5 and $id_destinos != 132 and $id_destinos != 158)
