...
<table width="999" border="0" align="center">
  <tr>
    <td width="235" height="30" class="titulo">Informes de Folios PT</td>
    ...
    <td colspan="3"><table width="1010" border="1" align="center" bordercolor="#CCCCCC">
      <tr>
		...
		<table width="502" border="0" align="center">
            <tr>
              <td colspan="2"><table width="610" border="0">
                <tr>
				...
				?>
				  ...
				  ?></td>
                  <td align="center" bgcolor="#FF9900"><a href="?modulo=informes_diarios.php" class="style3">Resumen Inventario</a></td>
                  </tr>
              </table></td>
              </tr>
            <tr>
              <td colspan="2" class="titulo"><table width="610" border="0">
                <tr>
                  <td width="139" height="22" bgcolor="#999999" class="titulo">&nbsp;Piking</td>
                  <td width="132" bgcolor="#FF9900">&nbsp;<input name="piking" type="text" class="cajas" id="piking" size="17" value="<? echo $piking ?>" />
                  </td>
                  <td width="150" bgcolor="#999999" class="titulo">&nbsp;Factura Venta N/I</td>
                  <td width="164" bgcolor="#FF9900">
                    &nbsp;<input name="factura" type="text" class="cajas" id="factura" size="17" value="<? echo $factura ?>" />
                  </td>
                  </tr>
              </table></td>
              </tr>
            <tr>
              <td colspan="2" class="titulo"><table width="610" border="0">
                ...
                <tr>
                  <td width="139" bgcolor="#999999" class="titulo">&nbsp;A&ntilde;o ( <span class="cajas"><? echo $entreano1?></span> -<span class="cajas"><? echo $entreano2?></span>) </td>
                  ...
                  <td width="68" bgcolor="#FF9900"><div align="center">
                    <input name="entreano2" type="text" class="cajas" id="entreano2" value="<? echo $entreano2 ?>" size="4" maxlength="4" />
                  </div></td>
                  <td width="150" bgcolor="#999999" class="titulo">&nbsp;Factura Importada:</td>
                  <td width="164" bgcolor="#FF9900">
                    &nbsp;<input name="factura_importada" type="text" class="cajas" id="factura_importada" size="17" value="<? echo $factura_importada ?>" />
                  </td>
                </tr>
              </table></td>
              </tr>
            ...
            <tr>
              <td colspan="2" class="titulo"><table width="610" border="0">
                <tr>
                  <td width="139" bgcolor="#999999" class="titulo">&nbsp;Desde N&deg; Folio:</td>
                  <td width="132" bgcolor="#FF9900">
                   &nbsp;<input name="desde" type="text" class="cajas" id="desde" size="17" value="<? echo $desde ?>" />
                  </td>
                  <td width="150" bgcolor="#999999" class="titulo">&nbsp;Hasta N&deg; Folio: </td>
                  <td width="164" bgcolor="#FF9900">
                    &nbsp;<input name="hasta" type="text" class="cajas" id="hasta" size="17" value="<? echo $hasta ?>" />
                  </td>
                </tr>
                <tr>
                  <td width="139" bgcolor="#999999" class="titulo">&nbsp;N&ordm; Bid&oacute;n Importado</td>
                  <td width="132" bgcolor="#FF9900">&nbsp;<input name="bidon_importado" type="text" class="cajas" id="bidon_importado" size="17" value="<? echo $bidon_importado ?>" /></td>
                  <td bgcolor="#999999" class="titulo">&nbsp;Origen Importado:</td>
                  <td width="162" bgcolor="#FF9900">
                  &nbsp;<?
		...
		echo $origen;
            ...
            <tr>
              <td colspan="2" class="titulo"><table width="281" border="0">
                <tr>
                  <td width="139" bgcolor="#999999" class="titulo">&nbsp;Gu&iacute;a Despacho</td>
                  <td width="132" bgcolor="#FF9900">&nbsp;<input name="guia_despacho_trazab" type="text" class="cajas" id="guia_despacho_trazab" size="17" value="<? echo $guia_despacho_trazab?>" /></td>
                  </tr>
              </table></td>
            </tr>
            <tr>
              <td colspan="2" class="titulo"><table width="610" height="29" border="0">
                <tr>
            ...
            <tr>
              <td valign="top">
				...
				if($buscar and $cuantos or $id_producto){
				  ...
				  ?>
                <a href="excel_etiquetas_folios.php?id_estado_folio=<? echo $id_estado_folio;?>&id_producto=<? echo $id_producto?>&desde=<? echo $desde?>&hasta=<? echo $hasta?>&fecha_ingresod=<? echo $fecha_ingresodesde?>&fecha_ingresoh=<? echo $fecha_ingresohasta?>&piking=<? echo $piking?>&entreano1=<? echo $entreano1?>&entreano2=<? echo $entreano2?>&id_caract_producto=<? echo $id_caract_producto?>&id_caract_envases=<? echo $id_caract_envases?>&piking=<? echo $piking?>&fecha_despachod=<? echo $fecha_despacho_desde_ok?>&fecha_despachoh=<? echo $fecha_despacho_hasta_ok?>&factura=<? echo $factura?>&compro_nro=<? echo $compro_nro?>&fecha_iniciodesde=<? echo $fecha_iniciodesde?>&fecha_iniciohasta=<? echo $fecha_iniciohasta?>&id_origen=<? echo $id_origen?>&factura_importada=<? echo $factura_importada?>&guia_despacho_trazab=<? echo $guia_despacho_trazab?>&id_cruce_tablas=<? echo $id_cruce_tablas?>" target="_blank"><img src="jpg/icono-excel.gif" width="33" height="33" border="0" /></a>&nbsp;&nbsp;&nbsp;<span class="titulo"><? echo "Cantidad de Folios (Bidones) $cuantos";?></span>
